...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  const broker = getMockBroker('xtb');

  // Customize the broker data for XTB
  broker.name = "XTB";
  broker.description = "XTB is a global forex and CFD broker offering access to thousands of financial markets including forex, indices, commodities, and shares.";
  broker.logo_url = "/images/brokers/xtb.png";
  broker.website_url = "https://www.xtb.com";
  broker.min_deposit = 0;
  broker.max_leverage = "1:30";
  broker.regulations = "FCA, KNF, CySEC";
  broker.trading_platforms = "xStation 5, MT4, Mobile App";
  broker.spreads_from = "0.1 pips";
  broker.account_types = ["Standard", "Pro"];
  broker.country = "Poland";
  broker.established = "2002";
  broker.overall_rating = 4.7;
  ...
  return {
    ...
    openGraph: {
      ...
      description: seoData.description,
      type: "article",
      url: `https://yoursite.com/brokers/xtb`,
      images: [
        {
...
export default async function BrokerReviewPage({ params }: Props) {
  ...
  broker.established = "2002";
  broker.overall_rating = 4.7;
  broker.pros = ["No minimum deposit", "Regulated by multiple authorities", "Competitive spreads", "Proprietary trading platform"];
  broker.cons = ["Limited product range compared to some competitors", "No US clients accepted"];
