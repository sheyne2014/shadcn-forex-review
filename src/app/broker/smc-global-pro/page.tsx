...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "SMC Global Pro Review 2025 | Expert Analysis of Professional Indian Trading Platform",
    description: "Comprehensive SMC Global Pro review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["SMC Global Pro review", "SMC Global Pro trading fees", "SMC Global Pro platforms", "forex broker review"],
    openGraph: {
      title: "SMC Global Pro Review 2025 | Expert Analysis of Professional Indian Trading Platform",
      description: "Comprehensive SMC Global Pro review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/smc-global-pro",
      type: "article",
    },
  };
}

export default async function SMCGlobalProReviewPage() {
  // SMC Global Pro broker data
  const broker = {
  ...
  const headline = "SMC Global Pro is a professional Indian trading platform renowned for its advanced tools and comprehensive market access. With sophisticated features and SEBI regulation, SMC Global Pro serves professional Indian traders seeking advanced trading capabilities with regulatory compliance.";
