...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "AMarkets ECN Review 2025 | Expert Analysis of ECN Multi-Asset Trading",
    description: "Comprehensive AMarkets ECN review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["AMarkets ECN review", "AMarkets ECN trading fees", "AMarkets ECN platforms", "forex broker review"],
    openGraph: {
      title: "AMarkets ECN Review 2025 | Expert Analysis of ECN Multi-Asset Trading",
      description: "Comprehensive AMarkets ECN review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/amarkets-ecn",
      type: "article",
    },
  };
}

export default async function AMarketsECNReviewPage() {
  // AMarkets ECN broker data
  const broker = {
  ...
  const headline = "AMarkets ECN is a specialized ECN broker renowned for its true ECN execution and affordable multi-asset trading. With copy trading features and multiple account types, AMarkets ECN serves traders seeking professional ECN conditions with accessible entry requirements.";
