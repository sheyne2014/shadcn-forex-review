...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "FXFlat Review 2025 | Expert Analysis of German BaFin-Regulated European Trading",
    description: "Comprehensive FXFlat review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["FXFlat review", "FXFlat trading fees", "FXFlat platforms", "forex broker review"],
    openGraph: {
      title: "FXFlat Review 2025 | Expert Analysis of German BaFin-Regulated European Trading",
      description: "Comprehensive FXFlat review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/fxflat",
      type: "article",
    },
  };
}

export default async function FXFlatReviewPage() {
  // FXFlat broker data
  const broker = {
  ...
  const headline = "FXFlat is a German BaFin-regulated broker renowned for its European market focus and comprehensive educational resources. With strong regulatory oversight and European expertise, FXFlat serves European traders seeking regulatory excellence with educational support.";
