...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Coincheck Review 2025 | Expert Analysis of Japanese-Regulated Crypto Exchange",
    description: "Comprehensive Coincheck review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Coincheck review", "Coincheck trading fees", "Coincheck platforms", "forex broker review"],
    openGraph: {
      title: "Coincheck Review 2025 | Expert Analysis of Japanese-Regulated Crypto Exchange",
      description: "Comprehensive Coincheck review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/coincheck",
      type: "article",
    },
  };
}

export default async function CoincheckReviewPage() {
  // Coincheck broker data
  const broker = {
    id: "f7000000-0000-0000-0000-000000001170",
    name: "Coincheck",
    logo_url: "/images/brokers/coincheck.png",
    ...
    trading_platforms: "Coincheck Platform, Coincheck Mobile, Coincheck API",
    ...
    website_url: "https://www.coincheck.com",
  ...
  const headline = "Coincheck is a Japanese-regulated crypto exchange renowned for its user-friendly interface and strong regulatory oversight. With comprehensive JFSA regulation and wide crypto selection, Coincheck serves Japanese crypto traders seeking regulated exchange with professional compliance.";
