...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "BitMax Review 2025 | Expert Analysis of Advanced Crypto Exchange",
    description: "Comprehensive BitMax review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["BitMax review", "BitMax trading fees", "BitMax platforms", "forex broker review"],
    openGraph: {
      title: "BitMax Review 2025 | Expert Analysis of Advanced Crypto Exchange",
      description: "Comprehensive BitMax review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/bitmax",
      type: "article",
    },
  };
}

export default async function BitMaxReviewPage() {
  // BitMax broker data
  const broker = {
  ...
  const headline = "BitMax is an advanced cryptocurrency exchange renowned for its high liquidity and institutional-grade services. With sophisticated trading features and professional infrastructure, BitMax serves serious crypto traders seeking advanced trading capabilities with institutional-quality execution.";
