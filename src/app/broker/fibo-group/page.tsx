...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "FIBO Group Review 2025 | Expert Analysis of Established Forex & Metals Specialist",
    description: "Comprehensive FIBO Group review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["FIBO Group review", "FIBO Group trading fees", "FIBO Group platforms", "forex broker review"],
    openGraph: {
      title: "FIBO Group Review 2025 | Expert Analysis of Established Forex & Metals Specialist",
      description: "Comprehensive FIBO Group review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/fibo-group",
      type: "article",
    },
  };
}

export default async function FIBOGroupReviewPage() {
  // FIBO Group broker data
  const broker = {
  ...
  const headline = "FIBO Group is an established forex and metals specialist with over 25 years of experience, offering competitive spreads and comprehensive educational resources. With strong CySEC regulation and deep market expertise, FIBO Group serves forex traders seeking reliability and professional education.";
