...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Gemini Review 2025 | Expert Analysis of Regulated & Insured",
    description: "Comprehensive Gemini review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Gemini review", "Gemini trading fees", "Gemini platforms", "forex broker review"],
    openGraph: {
      title: "Gemini Review 2025 | Expert Analysis of Regulated & Insured",
      description: "Comprehensive Gemini review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/gemini",
      type: "article",
    },
  };
}

export default async function GeminiReviewPage() {
  // Gemini broker data
  const broker = {
    id: "bf000000-0000-0000-0000-0000000000f0",
    name: "Gemini",
    logo_url: "/images/brokers/gemini.png",
    description: "Gemini is a regulated cryptocurrency exchange offering secure trading with insurance coverage. Key features include NYDFS regulation, FDIC insurance, $1 min deposit, strong compliance. Particularly suitable for security-conscious crypto investors. Updated May 2023.",
    min_deposit: 1,
    max_leverage: "1:500",
    regulations: "NYDFS, Various US states",
    trading_platforms: "Gemini Platform, ActiveTrader, Gemini Mobile",
    spreads_from: "0.35% spread",
    account_types: ["Standard", "Professional"],
    country: "USA",
    established: "2014",
    overall_rating: 4.3,
    pros: ["Strong regulatory compliance","Insurance coverage","User-friendly interface","Educational resources"],
    cons: ["Limited cryptocurrency selection","Higher fees","US-focused"],
    educational_resources: true,
    feature: "Regulated & Insured",
    ...
    faqs: [
      {
            ...
            "answer": "Gemini is regulated by NYDFS and various US state regulators, with the highest compliance standards."
      },
      {
            "question": "What is the minimum deposit for Gemini?",
            "answer": "Gemini has a minimum deposit of $1, making crypto investing accessible to all."
      },
      {
            "question": "Is Gemini insured?",
            "answer": "Yes, Gemini offers FDIC insurance on USD deposits and comprehensive insurance on crypto holdings."
      }
]
  };
  ...
  const headline = "Gemini is a highly regulated and insured cryptocurrency exchange founded by the Winklevoss twins, offering institutional-grade security and compliance. With FDIC insurance and strong regulatory oversight, Gemini provides peace of mind for security-conscious crypto investors.";
