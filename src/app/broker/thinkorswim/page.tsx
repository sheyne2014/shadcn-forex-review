...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "thinkorswim Review 2025 | Expert Analysis of Advanced Options Trading",
    description: "Comprehensive thinkorswim review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["thinkorswim review", "thinkorswim trading fees", "thinkorswim platforms", "forex broker review"],
    openGraph: {
      title: "thinkorswim Review 2025 | Expert Analysis of Advanced Options Trading",
      description: "Comprehensive thinkorswim review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/thinkorswim",
      type: "article",
    },
  };
}

export default async function thinkorswimReviewPage() {
  // thinkorswim broker data
  const broker = {
    id: "c5000000-0000-0000-0000-000000000150",
    name: "thinkorswim",
    logo_url: "/images/brokers/thinkorswim.png",
    description: "thinkorswim is a professional-grade trading platform offering advanced options trading, sophisticated charting, and comprehensive analysis tools. Key features include SEC, FINRA regulation, $0 min deposit, paper trading. Particularly suitable for active traders and options specialists. Updated May 2023.",
    min_deposit: 0,
    max_leverage: "1:500",
    ...
    established: "1999",
    overall_rating: 4.8,
    pros: ["Advanced options trading","Professional charting tools","Paper trading","Comprehensive education"],
    cons: ["Complex for beginners","Overwhelming interface","Requires learning curve"],
    educational_resources: true,
    feature: "Advanced Options Trading",
    website_url: "https://www.thinkorswim.com",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is thinkorswim regulated?",
            "answer": "thinkorswim is regulated by SEC, FINRA, and offers SIPC protection up to $500,000 per account."
      },
      {
            "question": "What is the minimum deposit for thinkorswim?",
            "answer": "thinkorswim has no minimum deposit requirement for standard accounts."
      },
      {
            "question": "What makes thinkorswim special for options trading?",
            "answer": "thinkorswim offers advanced options chains, probability analysis, and sophisticated strategy tools for professional options trading."
      }
]
  };
  ...
  const headline = "thinkorswim is the premier platform for advanced options trading and technical analysis, offering professional-grade tools and comprehensive educational resources. With sophisticated charting capabilities and paper trading features, thinkorswim serves serious traders who demand institutional-quality technology.";
