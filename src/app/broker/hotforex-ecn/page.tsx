...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "HotForex ECN Review 2025 | Expert Analysis of ECN Trading Specialist",
    description: "Comprehensive HotForex ECN review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["HotForex ECN review", "HotForex ECN trading fees", "HotForex ECN platforms", "forex broker review"],
    openGraph: {
      title: "HotForex ECN Review 2025 | Expert Analysis of ECN Trading Specialist",
      description: "Comprehensive HotForex ECN review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/hotforex-ecn",
      type: "article",
    },
  };
}

export default async function HotForexECNReviewPage() {
  // HotForex ECN broker data
  const broker = {
  ...
  const headline = "HotForex ECN is a professional ECN broker renowned for its institutional-grade execution and transparent pricing model. With tight spreads and direct market access, HotForex ECN serves professional traders who demand the highest execution quality and market transparency.";
