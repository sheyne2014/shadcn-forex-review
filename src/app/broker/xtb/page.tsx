...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "XTB Review 2025 | Expert Analysis of Award-Winning Platform",
    description: "Comprehensive XTB review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["XTB review", "XTB trading fees", "XTB platforms", "forex broker review"],
    openGraph: {
      title: "XTB Review 2025 | Expert Analysis of Award-Winning Platform",
      description: "Comprehensive XTB review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/xtb",
      type: "article",
    },
  };
}
...
export default async function XTBReviewPage() {
  ...
  const broker = {
    ...
    description: "XTB is a leading European broker offering award-winning trading platforms and comprehensive market access. Key features include FCA, CySEC, KNF regulation, $0 min deposit, xStation 5 platform. Particularly suitable for European traders seeking stocks, forex, and CFDs. Updated May 2023.",
    min_deposit: 0,
    max_leverage: "1:500",
