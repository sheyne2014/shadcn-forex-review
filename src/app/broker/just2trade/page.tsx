...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Just2Trade Review 2025 | Expert Analysis of Low-Cost Multi-Asset Trading",
    description: "Comprehensive Just2Trade review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Just2Trade review", "Just2Trade trading fees", "Just2Trade platforms", "forex broker review"],
    openGraph: {
      title: "Just2Trade Review 2025 | Expert Analysis of Low-Cost Multi-Asset Trading",
      description: "Comprehensive Just2Trade review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/just2trade",
      type: "article",
    },
  };
}

export default async function Just2TradeReviewPage() {
  // Just2Trade broker data
  const broker = {
  ...
  const headline = "Just2Trade is a low-cost multi-asset broker renowned for its competitive commissions and professional trading tools. With direct market access and strong regulatory oversight, Just2Trade serves active traders seeking affordable multi-asset trading with professional-grade execution.";
