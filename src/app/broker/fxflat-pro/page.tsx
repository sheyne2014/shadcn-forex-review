...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "FXFlat Pro Review 2025 | Expert Analysis of German BaFin-Regulated Professional Trading",
    description: "Comprehensive FXFlat Pro review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["FXFlat Pro review", "FXFlat Pro trading fees", "FXFlat Pro platforms", "forex broker review"],
    openGraph: {
      title: "FXFlat Pro Review 2025 | Expert Analysis of German BaFin-Regulated Professional Trading",
      description: "Comprehensive FXFlat Pro review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/fxflat-pro",
      type: "article",
    },
  };
}

export default async function FXFlatProReviewPage() {
  // FXFlat Pro broker data
  const broker = {
  ...
  const headline = "FXFlat Pro is a German BaFin-regulated professional broker renowned for its raw spreads and advanced trading platforms. With strong European regulatory oversight and professional-grade features, FXFlat Pro serves serious European traders seeking regulatory excellence with competitive pricing.";
