...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Moneta Markets Review 2025 | Expert Analysis of ASIC-Regulated ECN Trading",
    description: "Comprehensive Moneta Markets review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Moneta Markets review", "Moneta Markets trading fees", "Moneta Markets platforms", "forex broker review"],
    openGraph: {
      title: "Moneta Markets Review 2025 | Expert Analysis of ASIC-Regulated ECN Trading",
      description: "Comprehensive Moneta Markets review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/moneta-markets",
      type: "article",
    },
  };
}

export default async function MonetaMarketsReviewPage() {
  // Moneta Markets broker data
  const broker = {
  ...
  const headline = "Moneta Markets is a professionally regulated ECN broker renowned for its strong ASIC oversight and competitive spreads. With ECN execution and advanced tools, Moneta Markets serves traders seeking regulated access to institutional-grade trading conditions.";
