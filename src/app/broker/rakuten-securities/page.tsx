...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Rakuten Securities Review 2025 | Expert Analysis of Japanese Market Leader",
    description: "Comprehensive Rakuten Securities review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Rakuten Securities review", "Rakuten Securities trading fees", "Rakuten Securities platforms", "forex broker review"],
    openGraph: {
      title: "Rakuten Securities Review 2025 | Expert Analysis of Japanese Market Leader",
      description: "Comprehensive Rakuten Securities review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/rakuten-securities",
      type: "article",
    },
  };
}

export default async function RakutenSecuritiesReviewPage() {
  // Rakuten Securities broker data
  const broker = {
    id: "d4000000-0000-0000-0000-000000000240",
    name: "Rakuten Securities",
    logo_url: "/images/brokers/rakuten-securities.png",
    description: "Rakuten Securities is Japan's leading online broker offering comprehensive access to Japanese markets with low commissions and advanced tools. Key features include JFSA regulation, ¥0 min deposit, strong research. Particularly suitable for Japanese investors and those seeking Japanese market access. Updated May 2023.",
    min_deposit: 0,
    max_leverage: "1:500",
    regulations: "JFSA",
    ...
    established: "1999",
    overall_rating: 4.6,
    pros: ["No minimum deposit","Low commissions","Strong Japanese market access","Comprehensive research"],
    cons: ["Limited international markets","Japanese language focus","Complex for non-Japanese"],
    ...
    faqs: [
      {
            "question": "Is Rakuten Securities regulated?",
            "answer": "Rakuten Securities is regulated by the JFSA (Japan Financial Services Agency), ensuring comprehensive oversight."
      },
      {
            "question": "What is the minimum deposit for Rakuten Securities?",
            "answer": "Rakuten Securities has no minimum deposit requirement for most accounts."
      },
      {
            "question": "What markets can I access?",
            "answer": "Rakuten Securities offers comprehensive access to Japanese stocks, futures, options, and international markets."
      }
]
  };
  ...
  const headline = "Rakuten Securities is Japan's premier online brokerage, offering comprehensive access to Japanese markets with competitive commissions and advanced trading tools. With strong local expertise and innovative technology, Rakuten Securities serves investors seeking deep Japanese market access.";
