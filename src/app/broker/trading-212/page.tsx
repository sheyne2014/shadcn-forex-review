...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Trading 212 Review 2025 | Expert Analysis of Commission-Free Pioneer",
    description: "Comprehensive Trading 212 review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Trading 212 review", "Trading 212 trading fees", "Trading 212 platforms", "forex broker review"],
    openGraph: {
      title: "Trading 212 Review 2025 | Expert Analysis of Commission-Free Pioneer",
      description: "Comprehensive Trading 212 review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/trading-212",
      type: "article",
    },
  };
}

export default async function Trading212ReviewPage() {
  // Trading 212 broker data
  const broker = {
  ...
  const headline = "Trading 212 is a pioneering commission-free broker renowned for its ultra-low minimum deposits and user-friendly platform. With fractional shares and strong regulatory oversight, Trading 212 serves modern investors seeking accessible and affordable investing.";
