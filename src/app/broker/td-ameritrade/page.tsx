...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "TD Ameritrade Review 2025 | Expert Analysis of Advanced thinkorswim Platform",
    description: "Comprehensive TD Ameritrade review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["TD Ameritrade review", "TD Ameritrade trading fees", "TD Ameritrade platforms", "forex broker review"],
    openGraph: {
      title: "TD Ameritrade Review 2025 | Expert Analysis of Advanced thinkorswim Platform",
      description: "Comprehensive TD Ameritrade review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/td-ameritrade",
      type: "article",
    },
  };
}

export default async function TDAmeritradeReviewPage() {
  // TD Ameritrade broker data
  const broker = {
    id: "c2000000-0000-0000-0000-000000000120",
    name: "TD Ameritrade",
    logo_url: "/images/brokers/td-ameritrade.png",
    description: "TD Ameritrade offers advanced trading platforms including the renowned thinkorswim for active traders. Key features include SEC, FINRA regulation, $0 min deposit, advanced tools. Particularly suitable for active traders and options enthusiasts. Updated May 2023.",
    min_deposit: 0,
    max_leverage: "1:500",
    ...
    established: "1975",
    overall_rating: 4.6,
    pros: ["Advanced thinkorswim platform","Excellent education","Paper trading","Strong options trading"],
    cons: ["Now part of Charles Schwab","Complex platform","Limited international markets"],
    educational_resources: true,
    feature: "Advanced thinkorswim Platform",
    website_url: "https://www.tdameritrade.com",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is TD Ameritrade regulated?",
            "answer": "TD Ameritrade is regulated by SEC, FINRA, and provides SIPC protection up to $500,000."
      },
      {
            "question": "What is the minimum deposit for TD Ameritrade?",
            "answer": "TD Ameritrade has no minimum deposit requirement for standard accounts."
      },
      {
            "question": "What is thinkorswim?",
            "answer": "thinkorswim is TD Ameritrade's advanced trading platform with professional-grade tools and analytics."
      }
]
  };
  ...
  const headline = "TD Ameritrade is renowned for its advanced thinkorswim trading platform and comprehensive educational resources. With powerful tools for active traders and extensive options capabilities, TD Ameritrade serves serious traders who demand professional-grade technology.";
