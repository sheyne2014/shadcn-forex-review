...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Vantagepoint AI Review 2025 | Expert Analysis of AI-Powered ASIC-Regulated Trading",
    description: "Comprehensive Vantagepoint AI review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Vantagepoint AI review", "Vantagepoint AI trading fees", "Vantagepoint AI platforms", "forex broker review"],
    openGraph: {
      title: "Vantagepoint AI Review 2025 | Expert Analysis of AI-Powered ASIC-Regulated Trading",
      description: "Comprehensive Vantagepoint AI review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/vantagepoint-ai",
      type: "article",
    },
  };
}

export default async function VantagepointAIReviewPage() {
  // Vantagepoint AI broker data
  const broker = {
  ...
  const headline = "Vantagepoint AI is an AI-powered trading platform renowned for its intelligent trading tools and ASIC regulation. With very low minimum deposits and advanced AI capabilities, Vantagepoint AI serves traders seeking intelligent trading with regulatory compliance and accessible entry requirements.";
