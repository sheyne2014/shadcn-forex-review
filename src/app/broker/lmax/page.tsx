...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "LMAX Review 2025 | Expert Analysis of Institutional Liquidity",
    description: "Comprehensive LMAX review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["LMAX review", "LMAX trading fees", "LMAX platforms", "forex broker review"],
    openGraph: {
      title: "LMAX Review 2025 | Expert Analysis of Institutional Liquidity",
      description: "Comprehensive LMAX review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/lmax",
      type: "article",
    },
  };
}

export default async function LMAXReviewPage() {
  // LMAX broker data
  const broker = {
    id: "d3000000-0000-0000-0000-000000000230",
    name: "LMAX",
    logo_url: "/images/brokers/lmax.png",
    description: "LMAX is an institutional-grade forex exchange offering ultra-low latency execution and transparent pricing with deep liquidity. Key features include FCA regulation, $10,000 min deposit, institutional access. Particularly suitable for professional traders and institutions seeking institutional-quality execution. Updated May 2023.",
    min_deposit: 10000,
    max_leverage: "1:500",
    regulations: "FCA",
    trading_platforms: "LMAX Platform, MT4, FIX API",
    spreads_from: "From 0.1 pips",
    account_types: ["Standard", "Professional"],
    country: "UK",
    established: "2010",
    overall_rating: 4.6,
    pros: ["Institutional liquidity","Ultra-low latency","Transparent pricing","No dealing desk"],
    cons: ["Very high minimum deposit","Institutional focus","Limited retail features"],
    educational_resources: true,
    feature: "Institutional Liquidity",
    website_url: "https://www.lmax.com",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is LMAX regulated?",
            "answer": "LMAX is regulated by the FCA and operates as a Multilateral Trading Facility (MTF) in the UK."
      },
      {
            "question": "What is the minimum deposit for LMAX?",
            "answer": "LMAX has a minimum deposit of $10,000, reflecting its institutional focus."
      },
      {
            "question": "What makes LMAX different?",
            "answer": "LMAX operates as an exchange with institutional liquidity, transparent pricing, and ultra-low latency execution."
      }
]
  };
  ...
  const headline = "LMAX is the world's leading institutional forex exchange, offering ultra-low latency execution and transparent pricing with deep institutional liquidity. Designed for professional traders and institutions, LMAX provides exchange-quality execution with no dealing desk intervention.";
