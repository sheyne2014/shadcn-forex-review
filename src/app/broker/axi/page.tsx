...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Axi Review 2025 | Expert Analysis of Ultra-Low Entry Barrier",
    description: "Comprehensive Axi review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Axi review", "Axi trading fees", "Axi platforms", "forex broker review"],
    openGraph: {
      title: "Axi Review 2025 | Expert Analysis of Ultra-Low Entry Barrier",
      description: "Comprehensive Axi review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/axi",
      type: "article",
    },
  };
}

export default async function AxiReviewPage() {
  // Axi broker data
  const broker = {
  ...
  const headline = "Axi is a trusted Australian broker renowned for its ultra-low entry barriers and tight spreads, offering professional trading conditions with strong regulatory oversight. With accessible pricing and advanced tools, Axi serves traders seeking quality execution without high capital requirements.";
