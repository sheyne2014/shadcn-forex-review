...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "NBHM Review 2025 | Expert Analysis of FCA-Regulated Multi-Asset Platform",
    description: "Comprehensive NBHM review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["NBHM review", "NBHM trading fees", "NBHM platforms", "forex broker review"],
    openGraph: {
      title: "NBHM Review 2025 | Expert Analysis of FCA-Regulated Multi-Asset Platform",
      description: "Comprehensive NBHM review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/nbhm",
      type: "article",
    },
  };
}

export default async function NBHMReviewPage() {
  // NBHM broker data
  const broker = {
    id: "f3000000-0000-0000-0000-000000001130",
    name: "NBHM",
    logo_url: "/images/brokers/nbhm.png",
    ...
    trading_platforms: "MT4, MT5, NBHM Mobile",
    ...
    website_url: "https://www.nbhm.com",
  ...
  const headline = "NBHM is an FCA-regulated multi-asset platform renowned for its educational resources and competitive spreads. With strong regulatory oversight and diverse asset coverage, NBHM serves traders seeking FCA regulation with comprehensive multi-asset trading capabilities.";
