...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "CMC Markets Review 2025 | Expert Analysis of Comprehensive Market Access",
    description: "Comprehensive CMC Markets review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["CMC Markets review", "CMC Markets trading fees", "CMC Markets platforms", "forex broker review"],
    openGraph: {
      title: "CMC Markets Review 2025 | Expert Analysis of Comprehensive Market Access",
      description: "Comprehensive CMC Markets review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/cmc-markets",
      type: "article",
    },
  };
}

export default async function CMCMarketsReviewPage() {
  // CMC Markets broker data
  const broker = {
    id: "e8000000-0000-0000-0000-000000000380",
    name: "CMC Markets",
    logo_url: "/images/brokers/cmc-markets.png",
    description: "CMC Markets is a well-established multi-asset broker offering comprehensive market access with advanced charting and research tools. Key features include FCA, ASIC regulation, $0 min deposit, advanced tools. Particularly suitable for traders seeking comprehensive market coverage and research. Updated May 2023.",
    min_deposit: 0,
    max_leverage: "1:500",
    regulations: "FCA, ASIC, MAS",
    trading_platforms: "CMC Markets Platform, MT4, CMC Mobile",
    spreads_from: "From 0.7 pips",
    account_types: ["Standard", "Professional"],
    country: "UK",
    established: "1989",
    overall_rating: 4.5,
    pros: ["Strong regulation","Advanced charting","Wide market access","Research"],
    cons: ["Higher spreads","Complex platform","Inactivity fees"],
    educational_resources: true,
    feature: "Comprehensive Market Access",
    website_url: "https://www.cmcmarkets.com",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is CMC Markets regulated?",
            "answer": "CMC Markets is regulated by FCA, ASIC, and MAS, ensuring comprehensive regulatory oversight across major jurisdictions."
      },
      {
            "question": "What is the minimum deposit for CMC Markets?",
            "answer": "CMC Markets has no minimum deposit requirement for most account types."
      },
      {
            "question": "What markets can I access with CMC Markets?",
            "answer": "CMC Markets offers access to forex, stocks, indices, commodities, and cryptocurrencies across global markets."
      }
]
  };
  ...
  const headline = "CMC Markets is a trusted global broker offering comprehensive access to forex, stocks, indices, and commodities with advanced trading technology. With strong regulatory oversight and extensive research capabilities, CMC Markets serves traders seeking professional-grade tools and market coverage.";
