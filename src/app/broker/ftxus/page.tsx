...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "FTX.US Review 2025 | Expert Analysis of Advanced Crypto Exchange",
    description: "Comprehensive FTX.US review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["FTX.US review", "FTX.US trading fees", "FTX.US platforms", "forex broker review"],
    openGraph: {
      title: "FTX.US Review 2025 | Expert Analysis of Advanced Crypto Exchange",
      description: "Comprehensive FTX.US review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/ftxus",
      type: "article",
    },
  };
}

export default async function FTXUSReviewPage() {
  // FTX.US broker data
  const broker = {
  ...
  const headline = "FTX.US is a premier US cryptocurrency exchange renowned for its advanced trading features and institutional-grade security. With comprehensive crypto offerings and professional tools, FTX.US serves serious crypto traders who demand the highest standards and regulatory compliance.";
