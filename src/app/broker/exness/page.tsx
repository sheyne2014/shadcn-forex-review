...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Exness Review 2025 | Expert Analysis of Unlimited Leverage",
    description: "Comprehensive Exness review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Exness review", "Exness trading fees", "Exness platforms", "forex broker review"],
    openGraph: {
      title: "Exness Review 2025 | Expert Analysis of Unlimited Leverage",
      description: "Comprehensive Exness review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/exness",
      type: "article",
    },
  };
}
...
export default async function ExnessReviewPage() {
  ...
  const broker = {
    ...
    description: "Exness is a global forex broker offering unlimited leverage and fast execution with multiple account types. Key features include FCA, CySEC regulation, $0 min deposit, instant withdrawals. Particularly suitable for experienced traders seeking high leverage and flexible trading conditions. Updated May 2023.",
    min_deposit: 0,
    max_leverage: "1:500",
  ...
  const headline = "Exness is a leading global forex broker known for its unlimited leverage options, instant withdrawals, and flexible trading conditions. With strong regulatory oversight and multiple account types, Exness serves experienced traders who demand maximum trading flexibility.";
