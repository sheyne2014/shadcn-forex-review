...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "JustForex Review 2025 | Expert Analysis of Ultra-Accessible Multi-Asset Trading",
    description: "Comprehensive JustForex review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["JustForex review", "JustForex trading fees", "JustForex platforms", "forex broker review"],
    openGraph: {
      title: "JustForex Review 2025 | Expert Analysis of Ultra-Accessible Multi-Asset Trading",
      description: "Comprehensive JustForex review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/justforex",
      type: "article",
    },
  };
}

export default async function JustForexReviewPage() {
  // JustForex broker data
  const broker = {
    id: "f6000000-0000-0000-0000-000000001160",
    name: "JustForex",
    logo_url: "/images/brokers/justforex.png",
    ...
    trading_platforms: "MT4, MT5, JustForex Mobile",
    ...
    website_url: "https://www.justforex.com",
  ...
  const headline = "JustForex is an ultra-accessible multi-asset broker renowned for its $1 minimum deposit and educational resources. With extremely low barriers and comprehensive asset coverage, JustForex serves beginner traders seeking affordable entry to multi-asset trading.";
