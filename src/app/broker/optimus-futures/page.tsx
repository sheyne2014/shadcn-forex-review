...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Optimus Futures Review 2025 | Expert Analysis of Professional Futures Trading",
    description: "Comprehensive Optimus Futures review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Optimus Futures review", "Optimus Futures trading fees", "Optimus Futures platforms", "forex broker review"],
    openGraph: {
      title: "Optimus Futures Review 2025 | Expert Analysis of Professional Futures Trading",
      description: "Comprehensive Optimus Futures review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/optimus-futures",
      type: "article",
    },
  };
}

export default async function OptimusFuturesReviewPage() {
  // Optimus Futures broker data
  const broker = {
  ...
  const headline = "Optimus Futures is a professional futures broker renowned for its advanced trading platforms and competitive commissions. With comprehensive futures expertise and professional tools, Optimus Futures serves serious traders who demand institutional-quality futures trading.";
