...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "MultiBank Review 2025 | Expert Analysis of Multi-Regulated Global Broker",
    description: "Comprehensive MultiBank review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["MultiBank review", "MultiBank trading fees", "MultiBank platforms", "forex broker review"],
    openGraph: {
      title: "MultiBank Review 2025 | Expert Analysis of Multi-Regulated Global Broker",
      description: "Comprehensive MultiBank review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/multibank",
      type: "article",
    },
  };
}

export default async function MultiBankReviewPage() {
  // MultiBank broker data
  const broker = {
    id: "f7000000-0000-0000-0000-000000000470",
    name: "MultiBank",
    logo_url: "/images/brokers/multibank.png",
    description: "MultiBank is a global multi-asset broker offering forex, CFDs, and crypto trading with multiple regulatory licenses. Key features include CySEC, ASIC regulation, $50 min deposit, copy trading. Particularly suitable for traders seeking regulated multi-asset access with competitive conditions. Updated May 2023.",
    min_deposit: 50,
    max_leverage: "1:500",
    ...
    established: "2005",
    overall_rating: 4.4,
    pros: ["Multiple regulations","Low minimum deposit","Competitive spreads","Copy trading"],
    cons: ["Complex fee structure","Limited educational content","Withdrawal fees"],
    educational_resources: true,
    feature: "Multi-Regulated Global Broker",
    website_url: "https://www.multibank.com",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is MultiBank regulated?",
            "answer": "MultiBank is regulated by CySEC, ASIC, and ADGM, ensuring comprehensive regulatory oversight across multiple jurisdictions."
      },
      {
            "question": "What is the minimum deposit for MultiBank?",
            "answer": "MultiBank has a minimum deposit of $50 for most account types."
      },
      {
            "question": "What assets can I trade with MultiBank?",
            "answer": "MultiBank offers forex, CFDs, indices, commodities, and cryptocurrencies across global markets."
      }
]
  };
  ...
  const headline = "MultiBank is a trusted global broker offering comprehensive multi-asset trading with strong regulatory oversight across multiple jurisdictions. With competitive spreads and innovative features, MultiBank serves traders seeking reliable market access with professional support.";
