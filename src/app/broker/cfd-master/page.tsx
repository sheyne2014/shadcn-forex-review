...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "CFD Master Review 2025 | Expert Analysis of FCA-Regulated CFD Specialist",
    description: "Comprehensive CFD Master review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["CFD Master review", "CFD Master trading fees", "CFD Master platforms", "forex broker review"],
    openGraph: {
      title: "CFD Master Review 2025 | Expert Analysis of FCA-Regulated CFD Specialist",
      description: "Comprehensive CFD Master review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/cfd-master",
      type: "article",
    },
  };
}

export default async function CFDMasterReviewPage() {
  // CFD Master broker data
  const broker = {
    id: "f9000000-0000-0000-0000-000000001190",
    name: "CFD Master",
    logo_url: "/images/brokers/cfd-master.png",
    ...
    trading_platforms: "MT4, MT5, CFD Master Mobile",
    ...
    website_url: "https://www.cfdmaster.com",
  ...
  const headline = "CFD Master is an FCA-regulated CFD specialist renowned for its professional tools and educational resources. With strong regulatory oversight and CFD expertise, CFD Master serves serious CFD traders seeking specialized platform with regulatory compliance.";
