...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "OANDA Review 2025 | Expert Analysis of No Minimum Deposit",
    description: "Comprehensive OANDA review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["OANDA review", "OANDA trading fees", "OANDA platforms", "forex broker review"],
    openGraph: {
      title: "OANDA Review 2025 | Expert Analysis of No Minimum Deposit",
      description: "Comprehensive OANDA review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/oanda",
      type: "article",
    },
  };
}
...
export default async function OANDAReviewPage() {
  ...
  const broker = {
    ...
    description: "OANDA is a well-established forex broker offering trading services with no minimum deposit requirement. Key features include FCA, ASIC, CFTC, NFA regulation, $0 min deposit, 1:50 leverage. Particularly suitable for beginners and traders in the US and Canada. Updated May 2023.",
    min_deposit: 0,
    max_leverage: "1:500",
    ...
    faqs: [
      {
            ...
            "answer": "OANDA is regulated by FCA, ASIC, CFTC, and NFA, ensuring comprehensive regulatory oversight."
      },
      {
  ...
  const headline = "OANDA is a trusted forex broker with over 25 years of experience, offering no minimum deposit requirement and fractional pip pricing. With strong regulation in major markets and advanced charting capabilities, OANDA serves traders of all levels, particularly those in the US and Canada.";
