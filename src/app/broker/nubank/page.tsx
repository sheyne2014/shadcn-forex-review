...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Nubank Review 2025 | Expert Analysis of Brazilian Fintech Leader",
    description: "Comprehensive Nubank review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Nubank review", "Nubank trading fees", "Nubank platforms", "forex broker review"],
    openGraph: {
      title: "Nubank Review 2025 | Expert Analysis of Brazilian Fintech Leader",
      description: "Comprehensive Nubank review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/nubank",
      type: "article",
    },
  };
}

export default async function NubankReviewPage() {
  // Nubank broker data
  const broker = {
    id: "d0000000-0000-0000-0000-000000000200",
    name: "Nubank",
    logo_url: "/images/brokers/nubank.png",
    description: "Nubank is Brazil's leading fintech offering commission-free stock and crypto trading with innovative mobile-first approach. Key features include CVM, BACEN regulation, $0 min deposit, intuitive app. Particularly suitable for Brazilian investors seeking modern digital banking and investing. Updated May 2023.",
    min_deposit: 0,
    max_leverage: "1:500",
    ...
    established: "2013",
    overall_rating: 4.7,
    pros: ["No minimum deposit","Commission-free trading","User-friendly app","Strong fintech innovation"],
    cons: ["Limited to Brazilian market","Newer to investing","Limited advanced tools"],
    educational_resources: true,
    feature: "Brazilian Fintech Leader",
    website_url: "https://www.nubank.com.br",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is Nubank regulated?",
            "answer": "Nubank is regulated by CVM and BACEN, ensuring comprehensive oversight in the Brazilian market."
      },
      {
            "question": "What is the minimum deposit for Nubank?",
            "answer": "Nubank has no minimum deposit requirement, making investing accessible to all Brazilians."
      },
      {
            "question": "What can I trade with Nubank?",
            "answer": "Nubank offers Brazilian stocks, ETFs, and cryptocurrencies with commission-free trading."
      }
]
  };
  ...
  const headline = "Nubank is Brazil's largest fintech revolutionizing financial services with commission-free trading and innovative mobile-first approach. With strong regulatory oversight and user-friendly design, Nubank serves modern Brazilian investors who value simplicity and digital innovation.";
