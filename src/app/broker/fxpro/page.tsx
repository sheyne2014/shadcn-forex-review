...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "FxPro Review 2025 | Expert Analysis of Multiple Trading Platforms",
    description: "Comprehensive FxPro review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["FxPro review", "FxPro trading fees", "FxPro platforms", "forex broker review"],
    openGraph: {
      title: "FxPro Review 2025 | Expert Analysis of Multiple Trading Platforms",
      description: "Comprehensive FxPro review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/fxpro",
      type: "article",
    },
  };
}
...
export default async function FxProReviewPage() {
  ...
  const broker = {
    ...
    description: "FxPro is a well-established multi-asset broker offering multiple trading platforms and strong regulation across major jurisdictions. Key features include FCA, CySEC regulation, $100 min deposit, MT4/MT5/cTrader. Particularly suitable for traders seeking platform variety and regulatory security. Updated May 2023.",
    min_deposit: 100,
    max_leverage: "1:500",
    ...
    feature: "Multiple Trading Platforms",
  ...
  const headline = "FxPro is a trusted multi-asset broker offering comprehensive platform choice and strong regulatory oversight across major financial centers. With multiple trading platforms and no dealing desk execution, FxPro serves traders who value platform flexibility and regulatory security.";
