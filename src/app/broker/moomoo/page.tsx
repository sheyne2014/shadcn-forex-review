...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Moomoo Review 2025 | Expert Analysis of Social Analytics Trading",
    description: "Comprehensive Moomoo review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Moomoo review", "Moomoo trading fees", "Moomoo platforms", "forex broker review"],
    openGraph: {
      title: "Moomoo Review 2025 | Expert Analysis of Social Analytics Trading",
      description: "Comprehensive Moomoo review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/moomoo",
      type: "article",
    },
  };
}

export default async function MoomooReviewPage() {
  // Moomoo broker data
  const broker = {
  ...
  const headline = "Moomoo is an innovative commission-free broker renowned for its advanced analytics and social trading features. With comprehensive market data and intuitive tools, Moomoo serves data-driven traders seeking informed decision-making with commission-free execution.";
