...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "FXDD Review 2025 | Expert Analysis of Established Forex Specialist",
    description: "Comprehensive FXDD review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["FXDD review", "FXDD trading fees", "FXDD platforms", "forex broker review"],
    openGraph: {
      title: "FXDD Review 2025 | Expert Analysis of Established Forex Specialist",
      description: "Comprehensive FXDD review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/fxdd",
      type: "article",
    },
  };
}

export default async function FXDDReviewPage() {
  // FXDD broker data
  const broker = {
  ...
  const headline = "FXDD is an established forex specialist renowned for its competitive spreads and comprehensive educational resources. With over 20 years of experience and strong regulatory oversight, FXDD serves forex traders seeking reliability and professional trading conditions.";
