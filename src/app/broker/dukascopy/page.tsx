...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Dukascopy Review 2025 | Expert Analysis of Swiss Banking Excellence",
    description: "Comprehensive Dukascopy review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Dukascopy review", "Dukascopy trading fees", "Dukascopy platforms", "forex broker review"],
    openGraph: {
      title: "Dukascopy Review 2025 | Expert Analysis of Swiss Banking Excellence",
      description: "Comprehensive Dukascopy review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/dukascopy",
      type: "article",
    },
  };
}

export default async function DukascopyReviewPage() {
  // Dukascopy broker data
  const broker = {
  ...
  const headline = "Dukascopy is a premier Swiss ECN broker renowned for its institutional-grade trading technology and Swiss banking heritage. With transparent pricing and advanced execution, Dukascopy serves professional traders who demand the highest quality and reliability.";
