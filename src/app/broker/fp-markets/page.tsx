...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "FP Markets Review 2025 | Expert Analysis of Tight Spreads & Multiple Platforms",
    description: "Comprehensive FP Markets review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["FP Markets review", "FP Markets trading fees", "FP Markets platforms", "forex broker review"],
    openGraph: {
      title: "FP Markets Review 2025 | Expert Analysis of Tight Spreads & Multiple Platforms",
      description: "Comprehensive FP Markets review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/fp-markets",
      type: "article",
    },
  };
}

export default async function FPMarketsReviewPage() {
  // FP Markets broker data
  const broker = {
    id: "c6000000-0000-0000-0000-000000000160",
    name: "FP Markets",
    logo_url: "/images/brokers/fp-markets.png",
    description: "FP Markets is a leading Australian broker offering tight spreads and multiple trading platforms across forex, CFDs, and crypto. Key features include ASIC, CySEC regulation, $100 min deposit, MT4/MT5/IRESS. Particularly suitable for experienced traders seeking competitive pricing. Updated May 2023.",
    min_deposit: 100,
    max_leverage: "1:500",
    ...
    established: "2005",
    overall_rating: 4.7,
    pros: ["Tight spreads","Multiple platforms","Strong regulation","Excellent execution"],
    cons: ["Limited educational content","Complex fee structure","No US clients"],
    educational_resources: true,
    feature: "Tight Spreads & Multiple Platforms",
    website_url: "https://www.fpmarkets.com",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is FP Markets regulated?",
            "answer": "FP Markets is regulated by ASIC, CySEC, and FSCA, ensuring comprehensive regulatory oversight."
      },
      {
            "question": "What is the minimum deposit for FP Markets?",
            "answer": "FP Markets has a minimum deposit of $100 for most account types."
      },
      {
            "question": "What trading platforms does FP Markets offer?",
            "answer": "FP Markets offers MetaTrader 4, MetaTrader 5, IRESS, and cTrader platforms."
      }
]
  };
  ...
  const headline = "FP Markets is a premium Australian broker renowned for its tight spreads, multiple professional trading platforms, and excellent execution quality. With strong regulatory oversight and comprehensive market access, FP Markets serves experienced traders who demand competitive pricing and reliable performance.";
