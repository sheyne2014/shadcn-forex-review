...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "FXCM Review 2025 | Expert Analysis of Established Forex Pioneer",
    description: "Comprehensive FXCM review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["FXCM review", "FXCM trading fees", "FXCM platforms", "forex broker review"],
    openGraph: {
      title: "FXCM Review 2025 | Expert Analysis of Established Forex Pioneer",
      description: "Comprehensive FXCM review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/fxcm",
      type: "article",
    },
  };
}
...
export default async function FXCMReviewPage() {
  ...
  const headline = "FXCM is a pioneering forex broker with over two decades of experience, offering advanced trading technology and comprehensive educational resources. With strong regulatory oversight and global presence, FXCM serves forex traders seeking reliability and professional trading solutions.";
