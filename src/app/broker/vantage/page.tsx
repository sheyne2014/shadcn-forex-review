...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Vantage Review 2025 | Expert Analysis of Raw Spreads & Fast Execution",
    description: "Comprehensive Vantage review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Vantage review", "Vantage trading fees", "Vantage platforms", "forex broker review"],
    openGraph: {
      title: "Vantage Review 2025 | Expert Analysis of Raw Spreads & Fast Execution",
      description: "Comprehensive Vantage review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/vantage",
      type: "article",
    },
  };
}

export default async function VantageReviewPage() {
  // Vantage broker data
  const broker = {
    id: "d7000000-0000-0000-0000-000000000270",
    name: "Vantage",
    logo_url: "/images/brokers/vantage.png",
    description: "Vantage is a multi-regulated broker offering raw spreads and fast execution across forex, CFDs, and crypto markets. Key features include ASIC, FCA regulation, $200 min deposit, copy trading. Particularly suitable for traders seeking competitive pricing and reliable execution. Updated May 2023.",
    min_deposit: 200,
    max_leverage: "1:500",
    ...
    established: "2009",
    overall_rating: 4.6,
    pros: ["Raw spreads","Fast execution","Multiple regulations","Copy trading"],
    cons: ["Higher minimum deposit","Limited educational content","Complex fee structure"],
    educational_resources: true,
    feature: "Raw Spreads & Fast Execution",
    website_url: "https://www.vantagemarkets.com",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is Vantage regulated?",
            "answer": "Vantage is regulated by ASIC, FCA, and CIMA, ensuring comprehensive regulatory oversight across multiple jurisdictions."
      },
      {
            "question": "What is the minimum deposit for Vantage?",
            "answer": "Vantage has a minimum deposit of $200 for most account types."
      },
      {
            "question": "What is copy trading?",
            "answer": "Vantage offers copy trading features allowing you to automatically copy trades from successful traders."
      }
]
  };
  ...
  const headline = "Vantage is a trusted multi-regulated broker offering raw spreads, fast execution, and comprehensive market access across multiple asset classes. With strong regulatory oversight and innovative features like copy trading, Vantage serves traders seeking competitive conditions and reliable performance.";
