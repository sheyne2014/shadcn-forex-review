...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Liquid Review 2025 | Expert Analysis of High-Liquidity Crypto Exchange",
    description: "Comprehensive Liquid review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Liquid review", "Liquid trading fees", "Liquid platforms", "forex broker review"],
    openGraph: {
      title: "Liquid Review 2025 | Expert Analysis of High-Liquidity Crypto Exchange",
      description: "Comprehensive Liquid review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/liquid",
      type: "article",
    },
  };
}

export default async function LiquidReviewPage() {
  // Liquid broker data
  const broker = {
  ...
  const headline = "Liquid is a premier Japanese cryptocurrency exchange renowned for its high liquidity and advanced trading features. With strong regulatory oversight and institutional-grade security, Liquid serves professional crypto traders who demand the highest liquidity and reliability.";
