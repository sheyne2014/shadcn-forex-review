...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Bitfinex Review 2025 | Expert Analysis of Advanced Professional Trading",
    description: "Comprehensive Bitfinex review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Bitfinex review", "Bitfinex trading fees", "Bitfinex platforms", "forex broker review"],
    openGraph: {
      title: "Bitfinex Review 2025 | Expert Analysis of Advanced Professional Trading",
      description: "Comprehensive Bitfinex review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/bitfinex",
      type: "article",
    },
  };
}

export default async function BitfinexReviewPage() {
  // Bitfinex broker data
  const broker = {
    id: "e3000000-0000-0000-0000-000000000330",
    name: "Bitfinex",
    logo_url: "/images/brokers/bitfinex.png",
    description: "Bitfinex is a professional cryptocurrency exchange offering advanced trading features and high liquidity for serious crypto traders. Key features include margin trading, advanced orders, high liquidity. Particularly suitable for professional crypto traders and institutions. Updated May 2023.",
    min_deposit: 0,
    max_leverage: "1:500",
    regulations: "Various jurisdictions, Compliance programs",
    trading_platforms: "Bitfinex Platform, Bitfinex Mobile, Bitfinex API",
    spreads_from: "0.1% trading fee",
    account_types: ["Standard", "Professional"],
    country: "Hong Kong",
    established: "2012",
    overall_rating: 4.5,
    pros: ["Advanced trading features","High liquidity","Margin trading","Professional tools"],
    cons: ["Complex interface","Not for beginners","Regulatory restrictions"],
    educational_resources: true,
    feature: "Advanced Professional Trading",
    website_url: "https://www.bitfinex.com",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is Bitfinex regulated?",
            "answer": "Bitfinex operates under various regulatory frameworks and maintains compliance programs globally."
      },
      {
            "question": "What is the minimum deposit for Bitfinex?",
            "answer": "Bitfinex has no minimum deposit requirement for cryptocurrency trading."
      },
      {
            "question": "What advanced features does Bitfinex offer?",
            "answer": "Bitfinex offers margin trading, advanced order types, lending, and professional trading tools."
      }
]
  };
  ...
  const headline = "Bitfinex is a professional-grade cryptocurrency exchange renowned for its advanced trading features, high liquidity, and sophisticated tools. Designed for serious crypto traders and institutions, Bitfinex offers comprehensive trading capabilities with deep market access.";
