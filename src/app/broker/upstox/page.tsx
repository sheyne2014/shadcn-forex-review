...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Upstox Review 2025 | Expert Analysis of Indian Market Leader",
    description: "Comprehensive Upstox review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Upstox review", "Upstox trading fees", "Upstox platforms", "forex broker review"],
    openGraph: {
      title: "Upstox Review 2025 | Expert Analysis of Indian Market Leader",
      description: "Comprehensive Upstox review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/upstox",
      type: "article",
    },
  };
}

export default async function UpstoxReviewPage() {
  // Upstox broker data
  const broker = {
    id: "f3000000-0000-0000-0000-000000000430",
    name: "Upstox",
    logo_url: "/images/brokers/upstox.png",
    description: "Upstox is India's leading discount broker offering low-cost trading in Indian stocks, options, and futures with advanced technology. Key features include SEBI regulation, $0 min deposit, low fees. Particularly suitable for Indian investors seeking cost-effective trading with modern technology. Updated May 2023.",
    min_deposit: 0,
    max_leverage: "1:500",
    regulations: "SEBI, NSE, BSE",
    trading_platforms: "Upstox Pro, Upstox Mobile, Upstox Web",
    spreads_from: "Low brokerage",
    account_types: ["Standard", "Professional"],
    country: "India",
    established: "2009",
    overall_rating: 4.5,
    pros: ["No minimum deposit","Low brokerage fees","Advanced charting","Indian market focus"],
    cons: ["Limited international markets","India-focused","Complex for beginners"],
    educational_resources: true,
    feature: "Indian Market Leader",
    website_url: "https://www.upstox.com",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is Upstox regulated?",
            "answer": "Upstox is regulated by SEBI and is a member of NSE and BSE, ensuring comprehensive oversight in Indian markets."
      },
      {
            "question": "What is the minimum deposit for Upstox?",
            "answer": "Upstox has no minimum deposit requirement for trading accounts."
      },
      {
            "question": "What markets can I trade on Upstox?",
            "answer": "Upstox offers trading in Indian stocks, derivatives, commodities, and currency markets."
      }
]
  };
  ...
  const headline = "Upstox is India's premier discount brokerage, offering ultra-low fees and advanced trading technology for Indian markets. With strong regulatory oversight and innovative features, Upstox serves cost-conscious Indian investors who demand modern trading solutions.";
