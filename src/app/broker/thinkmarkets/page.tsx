...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "ThinkMarkets Review 2025 | Expert Analysis of Proprietary Platform Innovation",
    description: "Comprehensive ThinkMarkets review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["ThinkMarkets review", "ThinkMarkets trading fees", "ThinkMarkets platforms", "forex broker review"],
    openGraph: {
      title: "ThinkMarkets Review 2025 | Expert Analysis of Proprietary Platform Innovation",
      description: "Comprehensive ThinkMarkets review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/thinkmarkets",
      type: "article",
    },
  };
}

export default async function ThinkMarketsReviewPage() {
  // ThinkMarkets broker data
  const broker = {
  ...
  const headline = "ThinkMarkets is an innovative multi-asset broker renowned for its proprietary ThinkTrader platform and competitive spreads. With strong regulatory oversight and advanced technology, ThinkMarkets serves traders seeking cutting-edge platform innovation with professional trading conditions.";
