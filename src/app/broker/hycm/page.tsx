...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "HYCM Review 2025 | Expert Analysis of Established Global Broker",
    description: "Comprehensive HYCM review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["HYCM review", "HYCM trading fees", "HYCM platforms", "forex broker review"],
    openGraph: {
      title: "HYCM Review 2025 | Expert Analysis of Established Global Broker",
      description: "Comprehensive HYCM review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/hycm",
      type: "article",
    },
  };
}

export default async function HYCMReviewPage() {
  // HYCM broker data
  const broker = {
  ...
  const headline = "HYCM is a trusted global broker with over 40 years of experience, offering professional trading services across forex, CFDs, and commodities. With strong regulatory oversight and established reputation, HYCM serves traders seeking reliability and institutional-quality service.";
