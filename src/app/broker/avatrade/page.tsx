...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "AvaTrade Review 2025 | Expert Analysis of Multi-Regulated Copy Trading",
    description: "Comprehensive AvaTrade review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["AvaTrade review", "AvaTrade trading fees", "AvaTrade platforms", "forex broker review"],
    openGraph: {
      title: "AvaTrade Review 2025 | Expert Analysis of Multi-Regulated Copy Trading",
      description: "Comprehensive AvaTrade review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/avatrade",
      type: "article",
    },
  };
}
...
export default async function AvaTradeReviewPage() {
  // AvaTrade broker data
  const broker = {
    id: "d8000000-0000-0000-0000-000000000280",
    name: "AvaTrade",
    logo_url: "/images/brokers/avatrade.png",
    description: "AvaTrade is a well-established multi-regulated broker offering copy trading and comprehensive educational resources across multiple asset classes. Key features include CBI, ASIC regulation, $100 min deposit, multiple platforms. Particularly suitable for traders seeking copy trading and education. Updated May 2023.",
    min_deposit: 100,
    max_leverage: "1:500",
    ...
    feature: "Multi-Regulated Copy Trading",
    ...
    faqs: [
      {
            ...
            "answer": "AvaTrade is regulated by CBI, ASIC, FSCA, and ADGM, ensuring comprehensive regulatory oversight across multiple jurisdictions."
      },
      {
  ...
  const headline = "AvaTrade is a trusted multi-regulated broker known for its comprehensive copy trading features and extensive educational resources. With strong regulatory oversight across multiple jurisdictions and diverse platform options, AvaTrade serves traders seeking social trading and learning opportunities.";
