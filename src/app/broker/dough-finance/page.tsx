...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Dough Finance Review 2025 | Expert Analysis of Commission-Free Options Trading",
    description: "Comprehensive Dough Finance review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Dough Finance review", "Dough Finance trading fees", "Dough Finance platforms", "forex broker review"],
    openGraph: {
      title: "Dough Finance Review 2025 | Expert Analysis of Commission-Free Options Trading",
      description: "Comprehensive Dough Finance review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/dough-finance",
      type: "article",
    },
  };
}

export default async function DoughFinanceReviewPage() {
  // Dough Finance broker data
  const broker = {
  ...
  const headline = "Dough Finance is a commission-free options specialist renowned for its user-friendly interface and educational resources. With strong regulatory oversight and options-focused features, Dough Finance serves options traders seeking commission-free trading with comprehensive educational support.";
