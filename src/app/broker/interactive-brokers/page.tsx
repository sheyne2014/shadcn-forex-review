...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Interactive Brokers Review 2025 | Expert Analysis of Global Market Access",
    description: "Comprehensive Interactive Brokers review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Interactive Brokers review", "Interactive Brokers trading fees", "Interactive Brokers platforms", "forex broker review"],
    openGraph: {
      title: "Interactive Brokers Review 2025 | Expert Analysis of Global Market Access",
      description: "Comprehensive Interactive Brokers review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/interactive-brokers",
      type: "article",
    },
  };
}
...
export default async function InteractiveBrokersReviewPage() {
  // Interactive Brokers broker data
  const broker = {
    id: "b6000000-0000-0000-0000-000000000060",
    name: "Interactive Brokers",
    logo_url: "/images/brokers/interactive-brokers.png",
    description: "Interactive Brokers is a premier global broker offering access to stocks, options, futures, forex, and more across 150+ markets. Key features include SEC, FINRA, FCA regulation, $0 min deposit, advanced tools. Particularly suitable for professional traders and institutions seeking global market access. Updated May 2023.",
    min_deposit: 0,
    max_leverage: "1:500",
  ...
  const headline = "Interactive Brokers is a leading global broker providing access to 150+ markets worldwide with industry-low costs and advanced trading technology. Designed for professional traders and institutions, IBKR offers comprehensive tools and deep liquidity across multiple asset classes.";
