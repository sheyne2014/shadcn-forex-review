...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "FxPrimus Review 2025 | Expert Analysis of Professional ECN Trading",
    description: "Comprehensive FxPrimus review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["FxPrimus review", "FxPrimus trading fees", "FxPrimus platforms", "forex broker review"],
    openGraph: {
      title: "FxPrimus Review 2025 | Expert Analysis of Professional ECN Trading",
      description: "Comprehensive FxPrimus review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/fxprimus",
      type: "article",
    },
  };
}

export default async function FxPrimusReviewPage() {
  // FxPrimus broker data
  const broker = {
  ...
  const headline = "FxPrimus is a professional ECN broker renowned for its competitive spreads and advanced trading conditions. With multiple account types and professional tools, FxPrimus serves experienced traders seeking institutional-grade ECN execution.";
