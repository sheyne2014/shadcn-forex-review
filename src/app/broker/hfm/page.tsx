...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "HFM Review 2025 | Expert Analysis of Ultra-Accessible ECN Trading",
    description: "Comprehensive HFM review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["HFM review", "HFM trading fees", "HFM platforms", "forex broker review"],
    openGraph: {
      title: "HFM Review 2025 | Expert Analysis of Ultra-Accessible ECN Trading",
      description: "Comprehensive HFM review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/hfm",
      type: "article",
    },
  };
}

export default async function HFMReviewPage() {
  // HFM broker data
  const broker = {
  ...
  const headline = "HFM is a regulated ECN broker renowned for its ultra-low minimum deposits and strong regulatory oversight. With ECN execution and multiple account types, HFM serves traders seeking accessible entry to professional trading conditions with comprehensive regulation.";
