...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "dough Review 2025 | Expert Analysis of Simple Commission-Free Options Trading",
    description: "Comprehensive dough review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["dough review", "dough trading fees", "dough platforms", "forex broker review"],
    openGraph: {
      title: "dough Review 2025 | Expert Analysis of Simple Commission-Free Options Trading",
      description: "Comprehensive dough review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/dough",
      type: "article",
    },
  };
}

export default async function doughReviewPage() {
  // dough broker data
  const broker = {
    id: "f2000000-0000-0000-0000-000000001120",
    name: "dough",
    logo_url: "/images/brokers/dough.png",
  ...
  const headline = "dough is a simple commission-free options platform renowned for its user-friendly interface and accessible trading. With straightforward design and educational focus, dough serves beginner options traders seeking commission-free trading with simplified experience.";
