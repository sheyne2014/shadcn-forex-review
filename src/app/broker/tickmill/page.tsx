...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Tickmill Review 2025 | Expert Analysis of Tight Spreads & Fast Execution",
    description: "Comprehensive Tickmill review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Tickmill review", "Tickmill trading fees", "Tickmill platforms", "forex broker review"],
    openGraph: {
      title: "Tickmill Review 2025 | Expert Analysis of Tight Spreads & Fast Execution",
      description: "Comprehensive Tickmill review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/tickmill",
      type: "article",
    },
  };
}

export default async function TickmillReviewPage() {
  // Tickmill broker data
  const broker = {
    id: "e0000000-0000-0000-0000-000000000300",
    name: "Tickmill",
    logo_url: "/images/brokers/tickmill.png",
    description: "Tickmill is a UK-based forex broker offering tight spreads and fast execution with strong regulatory oversight. Key features include FCA, CySEC regulation, $100 min deposit, MT4/MT5. Particularly suitable for experienced traders seeking competitive pricing and reliable execution. Updated May 2023.",
    min_deposit: 100,
    max_leverage: "1:500",
    ...
    established: "2014",
    overall_rating: 4.5,
    pros: ["Tight spreads","Strong regulation","No dealing desk","Fast execution"],
    cons: ["Limited educational content","Higher minimum deposit","No US clients"],
    educational_resources: true,
    feature: "Tight Spreads & Fast Execution",
    website_url: "https://www.tickmill.com",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is Tickmill regulated?",
            "answer": "Tickmill is regulated by FCA, CySEC, and FSCA, ensuring comprehensive regulatory oversight across multiple jurisdictions."
      },
      {
            "question": "What is the minimum deposit for Tickmill?",
            "answer": "Tickmill has a minimum deposit of $100 for most account types."
      },
      {
            "question": "What makes Tickmill special?",
            "answer": "Tickmill offers some of the tightest spreads in the industry with fast execution and no dealing desk intervention."
      }
]
  };
  ...
  const headline = "Tickmill is a trusted forex broker known for its tight spreads, fast execution, and strong regulatory compliance. With no dealing desk intervention and competitive pricing, Tickmill serves experienced traders who demand reliable performance and transparent trading conditions.";
