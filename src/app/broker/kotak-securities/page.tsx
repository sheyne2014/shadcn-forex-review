...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Kotak Securities Review 2025 | Expert Analysis of Indian Market Specialist",
    description: "Comprehensive Kotak Securities review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Kotak Securities review", "Kotak Securities trading fees", "Kotak Securities platforms", "forex broker review"],
    openGraph: {
      title: "Kotak Securities Review 2025 | Expert Analysis of Indian Market Specialist",
      description: "Comprehensive Kotak Securities review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/kotak-securities",
      type: "article",
    },
  };
}

export default async function KotakSecuritiesReviewPage() {
  // Kotak Securities broker data
  const broker = {
  ...
  const headline = "Kotak Securities is India's premier full-service broker renowned for its comprehensive trading services and deep market expertise. With strong regulatory oversight and extensive offerings, Kotak Securities serves Indian investors seeking professional investment solutions.";
