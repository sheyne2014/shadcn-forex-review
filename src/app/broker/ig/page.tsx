...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "IG Review 2025 | Expert Analysis of Extensive Market Coverage",
    description: "Comprehensive IG review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["IG review", "IG trading fees", "IG platforms", "forex broker review"],
    openGraph: {
      title: "IG Review 2025 | Expert Analysis of Extensive Market Coverage",
      description: "Comprehensive IG review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/ig",
      type: "article",
    },
  };
}
...
export default async function IGReviewPage() {
  ...
  const broker = {
    ...
    description: "IG is a leading global provider offering extensive market coverage across forex, stocks, indices, and commodities with advanced trading tools. Key features include FCA, ASIC regulation, $250 min deposit, barrier options. Particularly suitable for experienced traders seeking comprehensive market access. Updated May 2023.",
    min_deposit: 250,
    max_leverage: "1:500",
    ...
    feature: "Extensive Market Coverage",
  ...
  const headline = "IG is a global leader in online trading, offering unparalleled market coverage and advanced trading tools across multiple asset classes. With nearly 50 years of experience and strong global regulation, IG serves serious traders who demand comprehensive market access and professional-grade technology.";
