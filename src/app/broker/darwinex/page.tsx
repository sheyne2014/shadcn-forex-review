...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Darwinex Review 2025 | Expert Analysis of Innovative DARWIN Copy Trading",
    description: "Comprehensive Darwinex review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Darwinex review", "Darwinex trading fees", "Darwinex platforms", "forex broker review"],
    openGraph: {
      title: "Darwinex Review 2025 | Expert Analysis of Innovative DARWIN Copy Trading",
      description: "Comprehensive Darwinex review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/darwinex",
      type: "article",
    },
  };
}

export default async function DarwinexReviewPage() {
  // Darwinex broker data
  const broker = {
  ...
  const headline = "Darwinex is an innovative FCA-regulated broker renowned for its unique DARWIN copy trading concept and transparent performance tracking. With cutting-edge technology and strong regulatory oversight, Darwinex serves traders seeking innovative copy trading solutions with professional regulation.";
