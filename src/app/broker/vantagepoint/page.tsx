...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Vantagepoint Review 2025 | Expert Analysis of Accessible ASIC-Regulated Multi-Asset Trading",
    description: "Comprehensive Vantagepoint review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Vantagepoint review", "Vantagepoint trading fees", "Vantagepoint platforms", "forex broker review"],
    openGraph: {
      title: "Vantagepoint Review 2025 | Expert Analysis of Accessible ASIC-Regulated Multi-Asset Trading",
      description: "Comprehensive Vantagepoint review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/vantagepoint",
      type: "article",
    },
  };
}

export default async function VantagepointReviewPage() {
  // Vantagepoint broker data
  const broker = {
  ...
  const headline = "Vantagepoint is an accessible ASIC-regulated broker renowned for its very low minimum deposits and multi-asset trading capabilities. With strong regulatory oversight and beginner-friendly approach, Vantagepoint serves new traders seeking ASIC regulation with affordable entry requirements.";
