...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Admirals Review 2025 | Expert Analysis of Multi-Regulated Broker",
    description: "Comprehensive Admirals review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Admirals review", "Admirals trading fees", "Admirals platforms", "forex broker review"],
    openGraph: {
      title: "Admirals Review 2025 | Expert Analysis of Multi-Regulated Broker",
      description: "Comprehensive Admirals review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/admirals",
      type: "article",
    },
  };
}
...
export default async function AdmiralsReviewPage() {
  // Admirals broker data
  const broker = {
    id: "d2000000-0000-0000-0000-000000000220",
    name: "Admirals",
    logo_url: "/images/brokers/admirals.png",
    description: "Admirals is a well-established multi-asset broker offering forex, CFDs, and crypto trading with strong regulation across multiple jurisdictions. Key features include FCA, CySEC, ASIC regulation, $100 min deposit, MT4/MT5. Particularly suitable for European traders seeking regulated multi-asset access. Updated May 2023.",
    min_deposit: 100,
    max_leverage: "1:500",
    ...
    feature: "Multi-Regulated Broker",
  ...
  const headline = "Admirals is a trusted multi-regulated broker offering comprehensive trading across forex, CFDs, and cryptocurrencies with strong regulatory oversight. With extensive educational resources and multiple platform options, Admirals serves traders seeking reliable and regulated market access.";
