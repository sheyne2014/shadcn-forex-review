...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Skilling Review 2025 | Expert Analysis of User-Friendly Multi-Asset Trading",
    description: "Comprehensive Skilling review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Skilling review", "Skilling trading fees", "Skilling platforms", "forex broker review"],
    openGraph: {
      title: "Skilling Review 2025 | Expert Analysis of User-Friendly Multi-Asset Trading",
      description: "Comprehensive Skilling review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/skilling",
      type: "article",
    },
  };
}

export default async function SkillingReviewPage() {
  // Skilling broker data
  const broker = {
  ...
  const headline = "Skilling is a modern multi-asset broker renowned for its user-friendly proprietary platform and strong regulatory oversight. With intuitive design and comprehensive asset coverage, Skilling serves traders seeking accessible multi-asset trading with professional regulation.";
