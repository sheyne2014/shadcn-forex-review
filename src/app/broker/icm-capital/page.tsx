...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "ICM Capital Review 2025 | Expert Analysis of FCA-Regulated Multi-Asset Trading",
    description: "Comprehensive ICM Capital review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["ICM Capital review", "ICM Capital trading fees", "ICM Capital platforms", "forex broker review"],
    openGraph: {
      title: "ICM Capital Review 2025 | Expert Analysis of FCA-Regulated Multi-Asset Trading",
      description: "Comprehensive ICM Capital review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/icm-capital",
      type: "article",
    },
  };
}

export default async function ICMCapitalReviewPage() {
  // ICM Capital broker data
  const broker = {
  ...
  const headline = "ICM Capital is an FCA-regulated multi-asset broker renowned for its competitive spreads and comprehensive educational resources. With strong regulatory oversight and diverse asset coverage, ICM Capital serves traders seeking FCA regulation with professional multi-asset trading capabilities.";
