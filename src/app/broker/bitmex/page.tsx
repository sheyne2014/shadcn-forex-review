...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "BitMEX Review 2025 | Expert Analysis of Advanced Crypto Derivatives",
    description: "Comprehensive BitMEX review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["BitMEX review", "BitMEX trading fees", "BitMEX platforms", "forex broker review"],
    openGraph: {
      title: "BitMEX Review 2025 | Expert Analysis of Advanced Crypto Derivatives",
      description: "Comprehensive BitMEX review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/bitmex",
      type: "article",
    },
  };
}

export default async function BitMEXReviewPage() {
  // BitMEX broker data
  const broker = {
  ...
  const headline = "BitMEX is a leading cryptocurrency derivatives exchange renowned for its advanced trading features and deep liquidity. With high leverage options and sophisticated derivatives products, BitMEX serves professional crypto traders seeking advanced derivatives trading capabilities.";
