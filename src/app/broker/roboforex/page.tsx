...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "RoboForex Review 2025 | Expert Analysis of Low Barrier Entry",
    description: "Comprehensive RoboForex review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["RoboForex review", "RoboForex trading fees", "RoboForex platforms", "forex broker review"],
    openGraph: {
      title: "RoboForex Review 2025 | Expert Analysis of Low Barrier Entry",
      description: "Comprehensive RoboForex review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/roboforex",
      type: "article",
    },
  };
}

export default async function RoboForexReviewPage() {
  // RoboForex broker data
  const broker = {
    id: "f8000000-0000-0000-0000-000000000480",
    name: "RoboForex",
    logo_url: "/images/brokers/roboforex.png",
    description: "RoboForex is a multi-asset broker offering forex, CFDs, and crypto trading with very low minimum deposits and multiple platforms. Key features include CySEC, IFSC regulation, $10 min deposit, copy trading. Particularly suitable for beginner traders seeking low-cost entry with multiple platform options. Updated May 2023.",
    min_deposit: 10,
    max_leverage: "1:500",
    ...
    established: "2009",
    overall_rating: 4.4,
    pros: ["Very low minimum deposit","Multiple platforms","Copy trading","Bonuses"],
    cons: ["Complex bonus terms","Withdrawal restrictions","Limited regulation"],
    educational_resources: true,
    feature: "Low Barrier Entry",
    website_url: "https://www.roboforex.com",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is RoboForex regulated?",
            "answer": "RoboForex is regulated by CySEC and IFSC, providing regulatory oversight for client protection."
      },
      {
            "question": "What is the minimum deposit for RoboForex?",
            "answer": "RoboForex has a minimum deposit of just $10, making trading accessible to everyone."
      },
      {
            "question": "What platforms does RoboForex offer?",
            "answer": "RoboForex offers MetaTrader 4, MetaTrader 5, cTrader, and their proprietary R Trader platform."
      }
]
  };
  ...
  const headline = "RoboForex is an accessible multi-asset broker known for its very low minimum deposits and comprehensive platform selection. With copy trading features and competitive conditions, RoboForex serves traders seeking affordable market access with diverse trading options.";
