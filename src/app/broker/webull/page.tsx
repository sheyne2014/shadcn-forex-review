...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Webull Review 2025 | Expert Analysis of Commission-Free Advanced Trading",
    description: "Comprehensive Webull review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Webull review", "Webull trading fees", "Webull platforms", "forex broker review"],
    openGraph: {
      title: "Webull Review 2025 | Expert Analysis of Commission-Free Advanced Trading",
      description: "Comprehensive Webull review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/webull",
      type: "article",
    },
  };
}

export default async function WebullReviewPage() {
  // Webull broker data
  const broker = {
  ...
  const headline = "Webull is a cutting-edge commission-free broker renowned for its advanced trading tools and real-time market data. With sophisticated charting and professional features, Webull serves active traders seeking institutional-quality tools without commission fees.";
