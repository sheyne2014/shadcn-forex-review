...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Vanguard Review 2025 | Expert Analysis of Low-Cost Long-Term Investing",
    description: "Comprehensive Vanguard review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Vanguard review", "Vanguard trading fees", "Vanguard platforms", "forex broker review"],
    openGraph: {
      title: "Vanguard Review 2025 | Expert Analysis of Low-Cost Long-Term Investing",
      description: "Comprehensive Vanguard review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/vanguard",
      type: "article",
    },
  };
}

export default async function VanguardReviewPage() {
  // Vanguard broker data
  const broker = {
    id: "c4000000-0000-0000-0000-000000000140",
    name: "Vanguard",
    logo_url: "/images/brokers/vanguard.png",
    description: "Vanguard is renowned for low-cost index funds and ETFs with a focus on long-term investing. Key features include SEC, FINRA regulation, $0 min deposit, low expense ratios. Particularly suitable for buy-and-hold investors and retirement planning. Updated May 2023.",
    min_deposit: 0,
    max_leverage: "1:500",
    ...
    established: "1975",
    overall_rating: 4.6,
    pros: ["Low-cost investing","Excellent ETFs and mutual funds","Long-term focus","Investor-owned structure"],
    cons: ["Limited trading tools","Basic platform","Not for active traders"],
    educational_resources: true,
    feature: "Low-Cost Long-Term Investing",
    website_url: "https://www.vanguard.com",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is Vanguard regulated?",
            "answer": "Vanguard is regulated by SEC, FINRA, and provides SIPC protection up to $500,000 per account."
      },
      {
            "question": "What is the minimum deposit for Vanguard?",
            "answer": "Vanguard has no minimum deposit for brokerage accounts, though some funds have minimums."
      },
      {
            "question": "What makes Vanguard special?",
            "answer": "Vanguard is investor-owned and known for the lowest expense ratios in the industry on index funds and ETFs."
      }
]
  };
  ...
  const headline = "Vanguard is the pioneer of low-cost index investing, known for its investor-owned structure and commitment to long-term wealth building. With industry-leading low expense ratios and comprehensive retirement planning tools, Vanguard serves investors focused on building wealth over time.";
