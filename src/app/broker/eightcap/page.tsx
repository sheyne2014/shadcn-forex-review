...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "EightCap Review 2025 | Expert Analysis of ASIC-Regulated Raw Spreads",
    description: "Comprehensive EightCap review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["EightCap review", "EightCap trading fees", "EightCap platforms", "forex broker review"],
    openGraph: {
      title: "EightCap Review 2025 | Expert Analysis of ASIC-Regulated Raw Spreads",
      description: "Comprehensive EightCap review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/eightcap",
      type: "article",
    },
  };
}

export default async function EightCapReviewPage() {
  // EightCap broker data
  const broker = {
  ...
  const headline = "EightCap is an ASIC-regulated broker renowned for its raw spreads from 0.0 pips and fast execution technology. With strong regulatory oversight and competitive pricing, EightCap serves traders seeking professional execution with transparent pricing across multiple asset classes.";
