...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "TradeZero Review 2025 | Expert Analysis of Commission-Free Short Selling",
    description: "Comprehensive TradeZero review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["TradeZero review", "TradeZero trading fees", "TradeZero platforms", "forex broker review"],
    openGraph: {
      title: "TradeZero Review 2025 | Expert Analysis of Commission-Free Short Selling",
      description: "Comprehensive TradeZero review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/tradezero",
      type: "article",
    },
  };
}

export default async function TradeZeroReviewPage() {
  // TradeZero broker data
  const broker = {
  ...
  const headline = "TradeZero is a specialized commission-free broker renowned for its advanced short selling capabilities and professional trading tools. With real-time data and sophisticated features, TradeZero serves active traders seeking commission-free access to advanced trading strategies.";
