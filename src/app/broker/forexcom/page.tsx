...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Forex.com Review 2025 | Expert Analysis of Established Forex Leader",
    description: "Comprehensive Forex.com review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Forex.com review", "Forex.com trading fees", "Forex.com platforms", "forex broker review"],
    openGraph: {
      title: "Forex.com Review 2025 | Expert Analysis of Established Forex Leader",
      description: "Comprehensive Forex.com review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/forexcom",
      type: "article",
    },
  };
}

export default async function ForexcomReviewPage() {
  // Forex.com broker data
  const broker = {
  ...
  const headline = "Forex.com is a trusted forex industry leader with over two decades of experience, offering comprehensive trading services and educational resources. With strong regulatory oversight and global presence, Forex.com serves traders seeking reliability and professional forex trading solutions.";
