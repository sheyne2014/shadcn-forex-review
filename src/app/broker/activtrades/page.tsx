...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "ActivTrades Review 2025 | Expert Analysis of Multi-Asset Trading",
    description: "Comprehensive ActivTrades review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["ActivTrades review", "ActivTrades trading fees", "ActivTrades platforms", "forex broker review"],
    openGraph: {
      title: "ActivTrades Review 2025 | Expert Analysis of Multi-Asset Trading",
      description: "Comprehensive ActivTrades review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/activtrades",
      type: "article",
    },
  };
}

export default async function ActivTradesReviewPage() {
  // ActivTrades broker data
  const broker = {
    id: "c8000000-0000-0000-0000-000000000180",
    name: "ActivTrades",
    logo_url: "/images/brokers/activtrades.png",
    description: "ActivTrades is a UK-based multi-asset broker offering forex, CFDs, and stocks with competitive spreads and strong regulation. Key features include FCA, SCB regulation, $0 min deposit, multiple platforms. Particularly suitable for European traders seeking diverse asset access. Updated May 2023.",
    min_deposit: 0,
    max_leverage: "1:500",
    ...
    established: "2001",
    overall_rating: 4.6,
    pros: ["No minimum deposit","Multi-asset platform","Strong regulation","Competitive spreads"],
    cons: ["Limited educational resources","No US clients","Weekend fees"],
    ...
    faqs: [
      {
            "question": "Is ActivTrades regulated?",
            "answer": "ActivTrades is regulated by FCA, SCB, and CMVM, ensuring strong regulatory compliance across multiple jurisdictions."
      },
      {
            "question": "What is the minimum deposit for ActivTrades?",
            "answer": "ActivTrades has no minimum deposit requirement, making it accessible to all traders."
      },
      {
            "question": "What assets can I trade with ActivTrades?",
            "answer": "ActivTrades offers forex, CFDs, stocks, indices, commodities, and cryptocurrencies across multiple markets."
      }
]
  };
  ...
  const headline = "ActivTrades is a well-established multi-asset broker offering comprehensive trading across forex, CFDs, and stocks with competitive pricing and strong regulatory oversight. With no minimum deposit and multiple platform options, ActivTrades serves traders seeking diverse market access with reliable execution.";
