...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "TradeStation Review 2025 | Expert Analysis of Advanced Trading Technology",
    description: "Comprehensive TradeStation review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["TradeStation review", "TradeStation trading fees", "TradeStation platforms", "forex broker review"],
    openGraph: {
      title: "TradeStation Review 2025 | Expert Analysis of Advanced Trading Technology",
      description: "Comprehensive TradeStation review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/tradestation",
      type: "article",
    },
  };
}

export default async function TradeStationReviewPage() {
  // TradeStation broker data
  const broker = {
    id: "e6000000-0000-0000-0000-000000000360",
    name: "TradeStation",
    logo_url: "/images/brokers/tradestation.png",
    description: "TradeStation is a professional trading platform offering advanced charting, algorithmic trading, and sophisticated analysis tools. Key features include SEC, FINRA regulation, $2,000 min deposit, advanced technology. Particularly suitable for professional traders and algorithmic trading. Updated May 2023.",
    min_deposit: 2000,
    max_leverage: "1:500",
    ...
    established: "1982",
    overall_rating: 4.5,
    pros: ["Advanced charting","Algorithmic trading","Professional tools","Research"],
    cons: ["High minimum deposit","Complex platform","Steep learning curve"],
    educational_resources: true,
    feature: "Advanced Trading Technology",
    website_url: "https://www.tradestation.com",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is TradeStation regulated?",
            "answer": "TradeStation is regulated by SEC, FINRA, and provides SIPC protection up to $500,000 per account."
      },
      {
            "question": "What is the minimum deposit for TradeStation?",
            "answer": "TradeStation has a minimum deposit of $2,000 for most account types."
      },
      {
            "question": "What makes TradeStation special?",
            "answer": "TradeStation offers advanced charting, algorithmic trading capabilities, and professional-grade analysis tools."
      }
]
  };
  ...
  const headline = "TradeStation is a premier trading platform renowned for its advanced technology, sophisticated charting, and algorithmic trading capabilities. With professional-grade tools and comprehensive research, TradeStation serves serious traders who demand institutional-quality technology.";
