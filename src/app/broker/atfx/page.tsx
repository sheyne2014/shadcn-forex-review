...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "ATFX Review 2025 | Expert Analysis of Global Multi-Asset Broker",
    description: "Comprehensive ATFX review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["ATFX review", "ATFX trading fees", "ATFX platforms", "forex broker review"],
    openGraph: {
      title: "ATFX Review 2025 | Expert Analysis of Global Multi-Asset Broker",
      description: "Comprehensive ATFX review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/atfx",
      type: "article",
    },
  };
}

export default async function ATFXReviewPage() {
  // ATFX broker data
  const broker = {
  ...
  const headline = "ATFX is a trusted global multi-asset broker renowned for its strong regulatory oversight and professional trading services. With comprehensive market access and educational support, ATFX serves traders seeking reliable global trading with institutional-quality service.";
