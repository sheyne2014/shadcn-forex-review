...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Bybit Review 2025 | Expert Analysis of Crypto Derivatives Specialist",
    description: "Comprehensive Bybit review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Bybit review", "Bybit trading fees", "Bybit platforms", "forex broker review"],
    openGraph: {
      title: "Bybit Review 2025 | Expert Analysis of Crypto Derivatives Specialist",
      description: "Comprehensive Bybit review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/bybit",
      type: "article",
    },
  };
}

export default async function BybitReviewPage() {
  // Bybit broker data
  const broker = {
    id: "f9000000-0000-0000-0000-000000000490",
    name: "Bybit",
    logo_url: "/images/brokers/bybit.png",
    description: "Bybit is a leading cryptocurrency derivatives exchange offering high leverage trading and advanced features for professional crypto traders. Key features include high leverage, low fees, advanced derivatives. Particularly suitable for experienced crypto traders seeking sophisticated derivatives trading. Updated May 2023.",
    min_deposit: 0,
    max_leverage: "1:500",
    ...
    established: "2018",
    overall_rating: 4.4,
    pros: ["High leverage","Advanced derivatives","Low fees","Fast execution"],
    cons: ["High risk","Complex for beginners","Regulatory uncertainties"],
    educational_resources: true,
    feature: "Crypto Derivatives Specialist",
    website_url: "https://www.bybit.com",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is Bybit regulated?",
            "answer": "Bybit operates under various regulatory frameworks and maintains compliance programs in multiple jurisdictions."
      },
      {
            "question": "What is the minimum deposit for Bybit?",
            "answer": "Bybit has no minimum deposit requirement for cryptocurrency trading."
      },
      {
            "question": "What makes Bybit special?",
            "answer": "Bybit specializes in cryptocurrency derivatives with high leverage options and advanced trading features for professionals."
      }
]
  };
  ...
  const headline = "Bybit is a premier cryptocurrency derivatives exchange renowned for its high leverage trading and advanced features for professional crypto traders. With fast execution and sophisticated tools, Bybit serves experienced traders who demand institutional-grade crypto derivatives trading.";
