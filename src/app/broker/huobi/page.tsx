...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Huobi Review 2025 | Expert Analysis of High Liquidity Exchange",
    description: "Comprehensive Huobi review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Huobi review", "Huobi trading fees", "Huobi platforms", "forex broker review"],
    openGraph: {
      title: "Huobi Review 2025 | Expert Analysis of High Liquidity Exchange",
      description: "Comprehensive Huobi review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/huobi",
      type: "article",
    },
  };
}

export default async function HuobiReviewPage() {
  // Huobi broker data
  const broker = {
  ...
  const headline = "Huobi is a premier cryptocurrency exchange renowned for its high liquidity and comprehensive digital asset selection. With advanced trading features and deep market access, Huobi serves crypto traders who demand institutional-grade liquidity and diverse cryptocurrency options.";
