...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "SoFi Invest Review 2025 | Expert Analysis of User-Friendly Commission-Free Investing",
    description: "Comprehensive SoFi Invest review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["SoFi Invest review", "SoFi Invest trading fees", "SoFi Invest platforms", "forex broker review"],
    openGraph: {
      title: "SoFi Invest Review 2025 | Expert Analysis of User-Friendly Commission-Free Investing",
      description: "Comprehensive SoFi Invest review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/sofi-invest",
      type: "article",
    },
  };
}

export default async function SoFiInvestReviewPage() {
  // SoFi Invest broker data
  const broker = {
