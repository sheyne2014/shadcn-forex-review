...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "AMarkets Review 2025 | Expert Analysis of Multi-Asset ECN Trading",
    description: "Comprehensive AMarkets review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["AMarkets review", "AMarkets trading fees", "AMarkets platforms", "forex broker review"],
    openGraph: {
      title: "AMarkets Review 2025 | Expert Analysis of Multi-Asset ECN Trading",
      description: "Comprehensive AMarkets review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/amarkets",
      type: "article",
    },
  };
}

export default async function AMarketsReviewPage() {
  // AMarkets broker data
  const broker = {
  ...
  const headline = "AMarkets is a versatile multi-asset broker renowned for its ECN execution and affordable trading conditions. With copy trading features and multiple account types, AMarkets serves traders seeking professional execution with accessible entry requirements.";
