...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Tradovate Futures Review 2025 | Expert Analysis of Cloud-Based Futures Platform",
    description: "Comprehensive Tradovate Futures review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Tradovate Futures review", "Tradovate Futures trading fees", "Tradovate Futures platforms", "forex broker review"],
    openGraph: {
      title: "Tradovate Futures Review 2025 | Expert Analysis of Cloud-Based Futures Platform",
      description: "Comprehensive Tradovate Futures review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/tradovate-futures",
      type: "article",
    },
  };
}

export default async function TradovateFuturesReviewPage() {
  // Tradovate Futures broker data
  const broker = {
  ...
  const headline = "Tradovate Futures is a cutting-edge cloud-based futures trading platform designed for the modern trader, offering competitive commissions and advanced technology. With mobile-first design and sophisticated tools, Tradovate serves futures traders who demand innovation and flexibility.";
