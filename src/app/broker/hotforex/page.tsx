...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "HotForex Review 2025 | Expert Analysis of Multi-Asset Trading Platform",
    description: "Comprehensive HotForex review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["HotForex review", "HotForex trading fees", "HotForex platforms", "forex broker review"],
    openGraph: {
      title: "HotForex Review 2025 | Expert Analysis of Multi-Asset Trading Platform",
      description: "Comprehensive HotForex review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/hotforex",
      type: "article",
    },
  };
}

export default async function HotForexReviewPage() {
  // HotForex broker data
  const broker = {
    id: "f0000000-0000-0000-0000-000000000400",
    name: "HotForex",
    logo_url: "/images/brokers/hotforex.png",
    description: "HotForex is a Cyprus-based multi-asset broker offering forex, CFDs, and crypto trading with strong regulation and educational resources. Key features include CySEC, FCA regulation, $50 min deposit, MT4/MT5. Particularly suitable for traders seeking regulated multi-asset access with educational support. Updated May 2023.",
    min_deposit: 50,
    max_leverage: "1:500",
    ...
    established: "2010",
    overall_rating: 4.5,
    pros: ["Low minimum deposit","Multiple account types","Strong regulation","Educational resources"],
    cons: ["Complex fee structure","Limited crypto options","Withdrawal fees"],
    educational_resources: true,
    feature: "Multi-Asset Trading Platform",
    website_url: "https://www.hotforex.com",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is HotForex regulated?",
            "answer": "HotForex is regulated by CySEC, FCA, and DFSA, ensuring comprehensive regulatory oversight across multiple jurisdictions."
      },
      {
            "question": "What is the minimum deposit for HotForex?",
            "answer": "HotForex has a minimum deposit of $50 for most account types."
      },
      {
            "question": "What assets can I trade with HotForex?",
            "answer": "HotForex offers forex, CFDs, indices, commodities, and cryptocurrencies across multiple markets."
      }
]
  };
  ...
  const headline = "HotForex is a trusted multi-asset broker known for its comprehensive trading offerings, strong regulatory oversight, and extensive educational resources. With multiple account types and competitive spreads, HotForex serves traders seeking reliable market access with professional support.";
