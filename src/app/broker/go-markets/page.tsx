...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "GO Markets Review 2025 | Expert Analysis of Professional ECN Trading",
    description: "Comprehensive GO Markets review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["GO Markets review", "GO Markets trading fees", "GO Markets platforms", "forex broker review"],
    openGraph: {
      title: "GO Markets Review 2025 | Expert Analysis of Professional ECN Trading",
      description: "Comprehensive GO Markets review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/go-markets",
      type: "article",
    },
  };
}

export default async function GOMarketsReviewPage() {
  // GO Markets broker data
  const broker = {
  ...
  const headline = "GO Markets is a professional ECN broker renowned for its strong ASIC regulation and advanced trading tools. With ECN execution and multiple account types, GO Markets serves professional traders seeking regulated access to institutional-grade trading conditions.";
