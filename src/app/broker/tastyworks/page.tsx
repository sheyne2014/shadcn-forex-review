...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Tastyworks Review 2025 | Expert Analysis of Options Trading Specialist",
    description: "Comprehensive Tastyworks review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Tastyworks review", "Tastyworks trading fees", "Tastyworks platforms", "forex broker review"],
    openGraph: {
      title: "Tastyworks Review 2025 | Expert Analysis of Options Trading Specialist",
      description: "Comprehensive Tastyworks review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/tastyworks",
      type: "article",
    },
  };
}

export default async function TastyworksReviewPage() {
  // Tastyworks broker data
  const broker = {
    id: "e5000000-0000-0000-0000-000000000350",
    name: "Tastyworks",
    logo_url: "/images/brokers/tastyworks.png",
    description: "Tastyworks is an options-focused brokerage offering advanced tools and low commissions for active options traders. Key features include SEC, FINRA regulation, $0 min deposit, options expertise. Particularly suitable for options traders and active investors. Updated May 2023.",
    min_deposit: 0,
    max_leverage: "1:500",
    ...
    established: "2017",
    overall_rating: 4.5,
    pros: ["Options-focused","Low commissions","Advanced tools","Educational content"],
    cons: ["Limited international markets","Complex for beginners","Options-centric"],
    educational_resources: true,
    feature: "Options Trading Specialist",
    website_url: "https://www.tastyworks.com",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is Tastyworks regulated?",
            "answer": "Tastyworks is regulated by SEC, FINRA, and provides SIPC protection up to $500,000 per account."
      },
      {
            "question": "What is the minimum deposit for Tastyworks?",
            "answer": "Tastyworks has no minimum deposit requirement for standard accounts."
      },
      {
            "question": "What makes Tastyworks special for options?",
            "answer": "Tastyworks offers advanced options tools, low commissions, and extensive options education from the tastytrade team."
      }
]
  };
  ...
  const headline = "Tastyworks is a cutting-edge brokerage designed specifically for options traders, offering advanced tools and competitive pricing. With a focus on options education and sophisticated trading features, Tastyworks serves active traders who specialize in options strategies.";
