...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "M4Markets Review 2025 | Expert Analysis of Raw Spreads Multi-Asset Trading",
    description: "Comprehensive M4Markets review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["M4Markets review", "M4Markets trading fees", "M4Markets platforms", "forex broker review"],
    openGraph: {
      title: "M4Markets Review 2025 | Expert Analysis of Raw Spreads Multi-Asset Trading",
      description: "Comprehensive M4Markets review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/m4markets",
      type: "article",
    },
  };
}

export default async function M4MarketsReviewPage() {
  // M4Markets broker data
  const broker = {
  ...
  const headline = "M4Markets is a raw spreads specialist renowned for its copy trading features and multi-asset access. With competitive pricing and diverse trading options, M4Markets serves traders seeking raw spreads with copy trading capabilities across multiple asset classes.";
