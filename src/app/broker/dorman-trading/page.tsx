...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Dorman Trading Review 2025 | Expert Analysis of Professional Futures Trading",
    description: "Comprehensive Dorman Trading review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Dorman Trading review", "Dorman Trading trading fees", "Dorman Trading platforms", "forex broker review"],
    openGraph: {
      title: "Dorman Trading Review 2025 | Expert Analysis of Professional Futures Trading",
      description: "Comprehensive Dorman Trading review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/dorman-trading",
      type: "article",
    },
  };
}

export default async function DormanTradingReviewPage() {
  // Dorman Trading broker data
  const broker = {
    ...
    spreads_from: "From $1.50 per contract",
  ...
  const headline = "Dorman Trading is a professional futures specialist with over 65 years of experience, offering competitive rates and advanced platforms. With personal service and deep futures expertise, Dorman Trading serves serious futures traders seeking professional execution and support.";
