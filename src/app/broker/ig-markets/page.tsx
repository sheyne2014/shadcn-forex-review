...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "IG Markets Review 2025 | Expert Analysis of Leading CFD Provider",
    description: "Comprehensive IG Markets review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["IG Markets review", "IG Markets trading fees", "IG Markets platforms", "forex broker review"],
    openGraph: {
      title: "IG Markets Review 2025 | Expert Analysis of Leading CFD Provider",
      description: "Comprehensive IG Markets review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/ig-markets",
      type: "article",
    },
  };
}

export default async function IGMarketsReviewPage() {
  // IG Markets broker data
  const broker = {
    id: "c9000000-0000-0000-0000-000000000190",
    name: "IG Markets",
    logo_url: "/images/brokers/ig-markets.png",
    description: "IG Markets is a leading global CFD provider offering extensive market coverage across forex, stocks, indices, and commodities. Key features include FCA, ASIC regulation, $250 min deposit, advanced tools. Particularly suitable for experienced traders seeking comprehensive market access. Updated May 2023.",
    min_deposit: 250,
    max_leverage: "1:500",
    ...
    established: "1974",
    overall_rating: 4.6,
    pros: ["Leading CFD provider","Extensive market coverage","Advanced charting","Strong research"],
    cons: ["Higher minimum deposit","Complex fee structure","Overwhelming for beginners"],
    educational_resources: true,
    feature: "Leading CFD Provider",
    website_url: "https://www.ig.com",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is IG Markets regulated?",
            "answer": "IG Markets is regulated by FCA, ASIC, MAS, and BaFin among others, with operations in major financial centers worldwide."
      },
      {
            "question": "What is the minimum deposit for IG Markets?",
            "answer": "IG Markets has a minimum deposit of $250 for most account types."
      },
      {
            "question": "What makes IG Markets special?",
            "answer": "IG Markets offers the world's largest selection of CFDs with over 17,000 markets and advanced trading technology."
      }
]
  };
  ...
  const headline = "IG Markets is the world's leading CFD provider, offering unparalleled market coverage and advanced trading tools across multiple asset classes. With nearly 50 years of experience and strong global regulation, IG Markets serves serious traders who demand comprehensive market access and professional-grade technology.";
