...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Kraken Review 2025 | Expert Analysis of Advanced Crypto Trading",
    description: "Comprehensive Kraken review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Kraken review", "Kraken trading fees", "Kraken platforms", "forex broker review"],
    openGraph: {
      title: "Kraken Review 2025 | Expert Analysis of Advanced Crypto Trading",
      description: "Comprehensive Kraken review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/kraken",
      type: "article",
    },
  };
}

export default async function KrakenReviewPage() {
  // Kraken broker data
  const broker = {
    id: "bd000000-0000-0000-0000-0000000000d0",
    name: "Kraken",
    logo_url: "/images/brokers/kraken.png",
    description: "Kraken is a professional cryptocurrency exchange offering advanced trading features and low fees. Key features include NYDFS, FCA regulation, $1 min deposit, futures trading. Particularly suitable for experienced crypto traders and institutions. Updated May 2023.",
    min_deposit: 1,
    max_leverage: "1:500",
    regulations: "NYDFS, FCA, JFSA",
    trading_platforms: "Kraken Platform, Kraken Pro, Kraken Mobile",
    spreads_from: "0.16% maker fee",
    account_types: ["Standard", "Professional"],
    country: "USA",
    established: "2011",
    overall_rating: 4.4,
    pros: ["Low trading fees","Advanced trading features","Strong security","Futures and margin trading"],
    cons: ["Complex interface for beginners","Limited customer support","Slower verification process"],
    educational_resources: true,
    feature: "Advanced Crypto Trading",
    website_url: "https://www.kraken.com",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is Kraken regulated?",
            "answer": "Kraken is regulated by NYDFS, FCA, and JFSA, with strong compliance across multiple jurisdictions."
      },
      {
            "question": "What is the minimum deposit for Kraken?",
            "answer": "Kraken has a minimum deposit of $1, making it accessible to all traders."
      },
      {
            "question": "What advanced features does Kraken offer?",
            "answer": "Kraken offers futures trading, margin trading, staking, and advanced order types for professional traders."
      }
]
  };
  ...
  const headline = "Kraken is a professional-grade cryptocurrency exchange known for its advanced trading features, low fees, and institutional-quality security. With comprehensive trading tools and futures markets, Kraken serves serious crypto traders and institutions worldwide.";
