...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Tradovate Review 2025 | Expert Analysis of Cloud-Based Futures Trading",
    description: "Comprehensive Tradovate review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Tradovate review", "Tradovate trading fees", "Tradovate platforms", "forex broker review"],
    openGraph: {
      title: "Tradovate Review 2025 | Expert Analysis of Cloud-Based Futures Trading",
      description: "Comprehensive Tradovate review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/tradovate",
      type: "article",
    },
  };
}

export default async function TradovateReviewPage() {
  // Tradovate broker data
  const broker = {
    id: "e9000000-0000-0000-0000-000000000390",
    name: "Tradovate",
    logo_url: "/images/brokers/tradovate.png",
    description: "Tradovate is a modern cloud-based futures trading platform offering low commissions and advanced tools for futures traders. Key features include CFTC, NFA regulation, $0 min deposit, cloud platform. Particularly suitable for futures traders seeking modern technology and competitive pricing. Updated May 2023.",
    min_deposit: 0,
    max_leverage: "1:500",
    regulations: "CFTC, NFA",
    trading_platforms: "Tradovate Platform, Tradovate Mobile, Tradovate API",
    spreads_from: "From $0.85 per contract",
    account_types: ["Standard", "Professional"],
    country: "USA",
    established: "2014",
    overall_rating: 4.5,
    pros: ["Cloud-based platform","Low commissions","Advanced tools","Mobile-first"],
    cons: ["Futures only","Limited educational content","New platform"],
    educational_resources: true,
    feature: "Cloud-Based Futures Trading",
    website_url: "https://www.tradovate.com",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is Tradovate regulated?",
            "answer": "Tradovate is regulated by CFTC and NFA, ensuring comprehensive oversight for futures trading."
      },
      {
            "question": "What is the minimum deposit for Tradovate?",
            "answer": "Tradovate has no minimum deposit requirement for futures trading accounts."
      },
      {
            "question": "What makes Tradovate special?",
            "answer": "Tradovate offers a modern cloud-based platform with competitive futures commissions and mobile-first design."
      }
]
  };
  ...
  const headline = "Tradovate is a cutting-edge cloud-based futures trading platform designed for the modern trader, offering competitive commissions and advanced technology. With mobile-first design and sophisticated tools, Tradovate serves futures traders who demand innovation and flexibility.";
