...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Firstrade Review 2025 | Expert Analysis of Commission-Free International Trading",
    description: "Comprehensive Firstrade review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Firstrade review", "Firstrade trading fees", "Firstrade platforms", "forex broker review"],
    openGraph: {
      title: "Firstrade Review 2025 | Expert Analysis of Commission-Free International Trading",
      description: "Comprehensive Firstrade review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/firstrade",
      type: "article",
    },
  };
}

export default async function FirstradeReviewPage() {
  // Firstrade broker data
  const broker = {
  ...
  const headline = "Firstrade is a pioneering commission-free broker renowned for its international trading capabilities and zero account fees. With comprehensive market access and straightforward pricing, Firstrade serves investors seeking affordable global investing without hidden costs.";
