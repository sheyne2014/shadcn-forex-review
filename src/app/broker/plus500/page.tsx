...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Plus500 Review 2025 | Expert Analysis of Simple CFD Trading",
    description: "Comprehensive Plus500 review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Plus500 review", "Plus500 trading fees", "Plus500 platforms", "forex broker review"],
    openGraph: {
      title: "Plus500 Review 2025 | Expert Analysis of Simple CFD Trading",
      description: "Comprehensive Plus500 review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/plus500",
      type: "article",
    },
  };
}
...
export default async function Plus500ReviewPage() {
  ...
  const broker = {
    ...
    description: "Plus500 is a leading CFD provider offering simple and intuitive trading platform. Key features include FCA, CySEC, ASIC regulation, $100 min deposit, 1:30 leverage. Particularly suitable for beginners and retail traders seeking straightforward CFD trading. Updated May 2023.",
    min_deposit: 100,
    max_leverage: "1:500",
