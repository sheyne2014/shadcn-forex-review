...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "OCTA Review 2025 | Expert Analysis of Accessible Multi-Asset Trading",
    description: "Comprehensive OCTA review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["OCTA review", "OCTA trading fees", "OCTA platforms", "forex broker review"],
    openGraph: {
      title: "OCTA Review 2025 | Expert Analysis of Accessible Multi-Asset Trading",
      description: "Comprehensive OCTA review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/octa",
      type: "article",
    },
  };
}

export default async function OCTAReviewPage() {
  // OCTA broker data
  const broker = {
  ...
  const headline = "OCTA is an accessible multi-asset broker renowned for its very low minimum deposits and comprehensive educational resources. With diverse trading options and copy trading features, OCTA serves beginner and intermediate traders seeking affordable access to multiple markets.";
