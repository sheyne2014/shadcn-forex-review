...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "eToro USA Review 2025 | Expert Analysis of Social Trading for US Investors",
    description: "Comprehensive eToro USA review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["eToro USA review", "eToro USA trading fees", "eToro USA platforms", "forex broker review"],
    openGraph: {
      title: "eToro USA Review 2025 | Expert Analysis of Social Trading for US Investors",
      description: "Comprehensive eToro USA review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/etoro-usa",
      type: "article",
    },
  };
}

export default async function eToroUSAReviewPage() {
  // eToro USA broker data
  const broker = {
  ...
  const headline = "eToro USA is a social trading platform renowned for its community-driven investing and commission-free trading. With innovative social features and strong regulatory oversight, eToro USA serves US investors seeking social trading with commission-free stocks and crypto access.";
