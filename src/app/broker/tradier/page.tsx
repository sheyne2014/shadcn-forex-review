...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Tradier Review 2025 | Expert Analysis of Developer-Friendly Options Trading",
    description: "Comprehensive Tradier review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Tradier review", "Tradier trading fees", "Tradier platforms", "forex broker review"],
    openGraph: {
      title: "Tradier Review 2025 | Expert Analysis of Developer-Friendly Options Trading",
      description: "Comprehensive Tradier review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/tradier",
      type: "article",
    },
  };
}

export default async function TradierReviewPage() {
  // Tradier broker data
  const broker = {
    ...
    spreads_from: "$0.35 per contract",
  ...
  const headline = "Tradier is a developer-friendly options broker renowned for its API access and modern technology. With low options commissions and comprehensive API capabilities, Tradier serves tech-savvy options traders seeking modern trading infrastructure with developer tools.";
