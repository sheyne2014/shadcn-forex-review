...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Windsor Brokers Review 2025 | Expert Analysis of Established ECN Trading",
    description: "Comprehensive Windsor Brokers review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Windsor Brokers review", "Windsor Brokers trading fees", "Windsor Brokers platforms", "forex broker review"],
    openGraph: {
      title: "Windsor Brokers Review 2025 | Expert Analysis of Established ECN Trading",
      description: "Comprehensive Windsor Brokers review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/windsor-brokers",
      type: "article",
    },
  };
}

export default async function WindsorBrokersReviewPage() {
  // Windsor Brokers broker data
  const broker = {
  ...
  const headline = "Windsor Brokers is an established ECN specialist with over 35 years of experience, offering strong regulatory oversight and comprehensive educational resources. With multiple account types and professional execution, Windsor Brokers serves traders seeking reliability and regulatory compliance.";
