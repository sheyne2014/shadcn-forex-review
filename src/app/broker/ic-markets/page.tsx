...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "IC Markets Review 2025 | Expert Analysis of Ultra-Low Spreads & Fast Execution",
    description: "Comprehensive IC Markets review. Discover ultra-low spreads from 0.0 pips, MT4/MT5/cTrader platforms, and lightning-fast execution speeds. Updated for 2025.",
    keywords: ["IC Markets review", "IC Markets spreads", "IC Markets platforms", "MT4", "MT5", "cTrader", "forex broker review", "ultra-low spreads", "fast execution"],
    openGraph: {
      title: "IC Markets Review 2025 | Expert Analysis of Ultra-Low Spreads & Fast Execution",
      description: "Comprehensive IC Markets review. Discover ultra-low spreads from 0.0 pips, MT4/MT5/cTrader platforms, and lightning-fast execution speeds. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/ic-markets",
      type: "article",
    },
  };
}
...
export default async function ICMarketsReviewPage() {
  // IC Markets broker data
  const broker = {
    id: "b3000000-0000-0000-0000-000000000030",
    name: "IC Markets",
    logo_url: "/images/brokers/ic-markets.png",
    description: "IC Markets is a leading forex and CFD broker offering ultra-low spreads and fast execution speeds. Key features include ASIC, CySEC, FSA regulation, $200 min deposit, 1:500 leverage. Particularly suitable for professional traders and scalpers seeking the best trading conditions. Updated May 2023.",
    min_deposit: 200,
    max_leverage: "1:500",
              ...
              <Card className="overflow-hidden border-border/80 hover:shadow-lg transition-all duration-300">
                ...
                <CardContent className="pt-6">
                  <p className="text-muted-foreground mb-6">
                    {broker.name} offers educational resources designed to help traders improve their trading knowledge and skills. The resources include market analysis, trading guides, and platform tutorials.
                  </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div className="bg-green-50 dark:bg-green-950/20 p-4 rounded-lg border border-green-100 dark:border-green-900/30">
                      ...
                      <ul className="space-y-3">
                        {[
                          "Professional trading guides and tutorials",
                    ...
                    <div className="bg-amber-50 dark:bg-amber-950/20 p-4 rounded-lg border border-amber-100 dark:border-amber-900/30">
                      ...
                      <ul className="space-y-3">
                        {[
                          "Advanced content may require account opening",
                          "Limited beginner-friendly content",
                          "Focus primarily on platform features"
                        ].map((weakness, index) => (
                          <li key={index} className="flex items-start">
