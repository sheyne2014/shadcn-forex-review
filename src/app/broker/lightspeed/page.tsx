...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Lightspeed Review 2025 | Expert Analysis of Professional Direct Market Access",
    description: "Comprehensive Lightspeed review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Lightspeed review", "Lightspeed trading fees", "Lightspeed platforms", "forex broker review"],
    openGraph: {
      title: "Lightspeed Review 2025 | Expert Analysis of Professional Direct Market Access",
      description: "Comprehensive Lightspeed review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/lightspeed",
      type: "article",
    },
  };
}

export default async function LightspeedReviewPage() {
  // Lightspeed broker data
  const broker = {
    ...
    spreads_from: "From $0.45 per contract",
  ...
  const headline = "Lightspeed is a premier professional trading platform renowned for its direct market access and high-speed execution. With advanced tools and institutional-grade technology, Lightspeed serves professional traders who demand the fastest execution and most sophisticated trading infrastructure.";
