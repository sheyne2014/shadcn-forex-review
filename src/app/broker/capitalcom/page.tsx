...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Capital.com Review 2025 | Expert Analysis of AI-Powered Trading Platform",
    ...
    openGraph: {
      title: "Capital.com Review 2025 | Expert Analysis of AI-Powered Trading Platform",
      description: "Comprehensive Capital.com review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/capitalcom",
      type: "article",
    },
  };
}
...
export default async function CapitalcomReviewPage() {
  ...
  const headline = "Capital.com is an innovative multi-asset broker renowned for its AI-powered trading insights and comprehensive market coverage. With strong regulatory oversight and intelligent trading tools, Capital.com serves modern traders who demand smart technology and diverse asset access.";
