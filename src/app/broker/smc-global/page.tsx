...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "SMC Global Review 2025 | Expert Analysis of Indian Multi-Asset Trading Specialist",
    description: "Comprehensive SMC Global review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["SMC Global review", "SMC Global trading fees", "SMC Global platforms", "forex broker review"],
    openGraph: {
      title: "SMC Global Review 2025 | Expert Analysis of Indian Multi-Asset Trading Specialist",
      description: "Comprehensive SMC Global review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/smc-global",
      type: "article",
    },
  };
}

export default async function SMCGlobalReviewPage() {
  // SMC Global broker data
  const broker = {
  ...
  const headline = "SMC Global is an Indian multi-asset specialist renowned for its comprehensive local market access and regulatory compliance. With deep Indian market expertise and SEBI regulation, SMC Global serves Indian traders seeking professional access to local markets with comprehensive support.";
