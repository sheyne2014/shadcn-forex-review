...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Mirae Asset Review 2025 | Expert Analysis of Korean Market Expertise",
    description: "Comprehensive Mirae Asset review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Mirae Asset review", "Mirae Asset trading fees", "Mirae Asset platforms", "forex broker review"],
    openGraph: {
      title: "Mirae Asset Review 2025 | Expert Analysis of Korean Market Expertise",
      description: "Comprehensive Mirae Asset review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/mirae-asset",
      type: "article",
    },
  };
}

export default async function MiraeAssetReviewPage() {
  // Mirae Asset broker data
  const broker = {
    id: "f4000000-0000-0000-0000-000000000440",
    name: "Mirae Asset",
    logo_url: "/images/brokers/mirae-asset.png",
    description: "Mirae Asset is a leading Korean financial services company offering comprehensive investment solutions with strong research capabilities. Key features include FSC regulation, $0 min deposit, global reach. Particularly suitable for investors seeking Korean market access and Asian investment expertise. Updated May 2023.",
    min_deposit: 0,
    max_leverage: "1:500",
    regulations: "FSC, KRX",
    ...
    established: "1997",
    overall_rating: 4.5,
    pros: ["No minimum deposit","Korean market expertise","Global reach","Research capabilities"],
    cons: ["Limited international access","Language barriers","Complex fee structure"],
    educational_resources: true,
    feature: "Korean Market Expertise",
    website_url: "https://www.miraeasset.com",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is Mirae Asset regulated?",
            "answer": "Mirae Asset is regulated by the FSC (Financial Services Commission) in South Korea and operates globally."
      },
      {
            "question": "What is the minimum deposit for Mirae Asset?",
            "answer": "Mirae Asset has no minimum deposit requirement for most investment accounts."
      },
      {
            "question": "What makes Mirae Asset special?",
            "answer": "Mirae Asset offers deep Korean and Asian market expertise with comprehensive research and global investment solutions."
      }
]
  };
  ...
  const headline = "Mirae Asset is a premier Korean financial services company renowned for its comprehensive investment solutions and strong research capabilities. With global reach and deep Asian market expertise, Mirae Asset serves investors seeking professional investment management and market access.";
