...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "FXTM Review 2025 | Expert Analysis of Educational Focus Broker",
    description: "Comprehensive FXTM review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["FXTM review", "FXTM trading fees", "FXTM platforms", "forex broker review"],
    openGraph: {
      title: "FXTM Review 2025 | Expert Analysis of Educational Focus Broker",
      description: "Comprehensive FXTM review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/fxtm",
      type: "article",
    },
  };
}

export default async function FXTMReviewPage() {
  // FXTM broker data
  const broker = {
  ...
  const headline = "FXTM is a trusted multi-asset broker renowned for its comprehensive educational resources and strong regulatory oversight. With diverse trading options and professional support, FXTM serves traders seeking knowledge-driven trading with reliable market access.";
