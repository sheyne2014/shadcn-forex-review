...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "M1 Finance Review 2025 | Expert Analysis of Automated Portfolio Management",
    description: "Comprehensive M1 Finance review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["M1 Finance review", "M1 Finance trading fees", "M1 Finance platforms", "forex broker review"],
    openGraph: {
      title: "M1 Finance Review 2025 | Expert Analysis of Automated Portfolio Management",
      description: "Comprehensive M1 Finance review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/m1-finance",
      type: "article",
    },
  };
}

export default async function M1FinanceReviewPage() {
  // M1 Finance broker data
  const broker = {
  ...
  const headline = "M1 Finance is an innovative automated investing platform renowned for its portfolio optimization and commission-free trading. With fractional shares and intelligent automation, M1 Finance serves long-term investors seeking hands-off portfolio management with professional optimization.";
