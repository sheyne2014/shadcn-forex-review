...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "FXOpen Review 2025 | Expert Analysis of Ultra-Accessible ECN Trading",
    description: "Comprehensive FXOpen review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["FXOpen review", "FXOpen trading fees", "FXOpen platforms", "forex broker review"],
    openGraph: {
      title: "FXOpen Review 2025 | Expert Analysis of Ultra-Accessible ECN Trading",
      description: "Comprehensive FXOpen review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/fxopen",
      type: "article",
    },
  };
}

export default async function FXOpenReviewPage() {
  // FXOpen broker data
  const broker = {
  ...
  const headline = "FXOpen is a trusted multi-asset broker renowned for its ultra-low minimum deposits and ECN execution quality. With strong regulatory oversight and professional trading conditions, FXOpen serves traders seeking accessible entry to institutional-grade trading.";
