...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Alpha Trading Review 2025 | Expert Analysis of ASIC-Regulated Multi-Asset Trading",
    description: "Comprehensive Alpha Trading review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Alpha Trading review", "Alpha Trading trading fees", "Alpha Trading platforms", "forex broker review"],
    openGraph: {
      title: "Alpha Trading Review 2025 | Expert Analysis of ASIC-Regulated Multi-Asset Trading",
      description: "Comprehensive Alpha Trading review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/alpha-trading",
      type: "article",
    },
  };
}

export default async function AlphaTradingReviewPage() {
  // Alpha Trading broker data
  const broker = {
  ...
  const headline = "Alpha Trading is an ASIC-regulated multi-asset specialist renowned for its competitive spreads and comprehensive educational resources. With strong regulatory oversight and diverse asset coverage, Alpha Trading serves traders seeking reliable multi-asset trading with professional regulation.";
