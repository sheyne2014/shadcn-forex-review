...
export async function generateMetadata(): Promise<Metadata> {
  return {
    title: "Degiro Review 2025 | Expert Analysis of Ultra-Low Cost Trading",
    description: "Comprehensive Degiro review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
    keywords: ["Degiro review", "Degiro trading fees", "Degiro platforms", "forex broker review"],
    openGraph: {
      title: "Degiro Review 2025 | Expert Analysis of Ultra-Low Cost Trading",
      description: "Comprehensive Degiro review. Discover trading fees, platforms, regulation, and key features. Updated for 2025.",
      url: "https://brokeranalysis.com/broker/degiro",
      type: "article",
    },
  };
}

export default async function DegiroReviewPage() {
  // Degiro broker data
  const broker = {
    id: "e7000000-0000-0000-0000-000000000370",
    name: "Degiro",
    logo_url: "/images/brokers/degiro.png",
    description: "Degiro is a European discount broker offering ultra-low cost trading across global markets with comprehensive European regulation. Key features include AFM, DNB regulation, $0 min deposit, low fees. Particularly suitable for cost-conscious European investors seeking global market access. Updated May 2023.",
    min_deposit: 0,
    max_leverage: "1:500",
    ...
    established: "2008",
    overall_rating: 4.5,
    pros: ["Very low fees","Wide market access","European regulation","No minimum deposit"],
    cons: ["Limited customer service","Basic platform","No US stocks for some"],
    educational_resources: true,
    feature: "Ultra-Low Cost Trading",
    website_url: "https://www.degiro.eu",
    published_date: "2023-05-15",
    last_updated: "2023-05-15",
    faqs: [
      {
            "question": "Is Degiro regulated?",
            "answer": "Degiro is regulated by AFM, DNB, and BaFin, ensuring comprehensive European regulatory oversight."
      },
      {
            "question": "What is the minimum deposit for Degiro?",
            "answer": "Degiro has no minimum deposit requirement, making investing accessible to everyone."
      },
      {
            "question": "What makes Degiro special?",
            "answer": "Degiro offers some of the lowest trading fees in Europe with access to global markets and strong regulation."
      }
]
  };
  ...
  const headline = "Degiro is Europe's leading low-cost broker, offering ultra-competitive fees and access to global markets with strong European regulation. With transparent pricing and comprehensive market coverage, Degiro serves cost-conscious investors who prioritize value and market access.";
