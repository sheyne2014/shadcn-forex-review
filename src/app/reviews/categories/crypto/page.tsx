...
export const metadata: Metadata = {
  title: "Best Crypto Broker Reviews 2025 | Expert Analysis",
  description: "In-depth reviews of the top crypto brokers for 2025. Compare platforms, trading conditions, fees, and features to find the best crypto broker for your needs.",
};

// Crypto brokers to review
const cryptoBrokers = [
  {
    name: "Coinbase",
    slug: "coinbase",
    description: "Leading crypto exchange with user-friendly interface and strong security.",
    logoUrl: "/broker-logos-simple/coinbase_clearbit.png",
    rating: 4.7,
    minDeposit: 2,
    tradingFee: "0.5%",
  },
  {
    name: "Binance",
    slug: "binance",
    description: "World's largest crypto exchange with extensive coin selection and low fees.",
    logoUrl: "/broker-logos-simple/binance_clearbit.png",
    rating: 4.8,
    minDeposit: 10,
    tradingFee: "0.1%",
  },
  {
    name: "Kraken",
    slug: "kraken",
    description: "Established crypto exchange with advanced trading features and security.",
    logoUrl: "/broker-logos-simple/kraken_clearbit.png",
    rating: 4.6,
    minDeposit: 10,
    tradingFee: "0.26%",
  },
  {
    name: "eToro",
    slug: "broker/etoro",
    description: "Social trading platform offering crypto CFDs with copy trading features.",
  ...
  },
  {
    name: "Gemini",
    slug: "gemini",
    description: "Regulated crypto exchange with institutional-grade security.",
    logoUrl: "/broker-logos-simple/gemini_clearbit.png",
    rating: 4.5,
    minDeposit: 1,
    tradingFee: "0.35%",
  },
...
export default function CryptoReviewsPage() {
  return (
    <div className="container py-12">
      <div className="max-w-5xl mx-auto space-y-12">
        <div className="space-y-6">
          <div className="text-center space-y-4">
            <h1 className="text-4xl font-bold tracking-tight">Crypto Broker Reviews 2025</h1>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              In-depth, unbiased reviews of the top crypto brokers with expert analysis
            </p>
          </div>

          <div className="bg-muted p-6 rounded-lg">
            <p>
              Our crypto broker reviews are based on extensive testing and research. We evaluate each broker on multiple factors including
        ...
        <div className="space-y-8">
          {cryptoBrokers.map((broker, index) => (
                  ...
                  <CardContent className="px-0 space-y-4">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                      ...
                      <div className="bg-muted p-3 rounded-md text-center">
                        ...
                        <div className="font-medium">{broker.tradingFee}</div>
                      </div>
                      <div className="bg-muted p-3 rounded-md text-center">
        ...
        <div className="bg-muted p-8 rounded-lg space-y-6">
          <div className="text-center">
            <h2 className="text-2xl font-bold">How We Rate Crypto Brokers</h2>
          ...
          <div className="grid md:grid-cols-2 gap-6">
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                <li className="flex items-start gap-2">
                  ...
                  <span>Trading fees across major cryptocurrencies</span>
                </li>
                <li className="flex items-start gap-2">
                  <Badge variant="outline" className="mt-1">✓</Badge>
                  <span>Deposit and withdrawal fees</span>
                </li>
                <li className="flex items-start gap-2">
                  <Badge variant="outline" className="mt-1">✓</Badge>
                  <span>Spread analysis on popular pairs</span>
                </li>
              </ul>
            </div>
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-2">
                ...
                <li className="flex items-start gap-2">
                  <Badge variant="outline" className="mt-1">✓</Badge>
                  <span>Platform usability and tools</span>
                </li>
              </ul>
            </div>
          </div>
