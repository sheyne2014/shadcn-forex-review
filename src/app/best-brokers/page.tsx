...
export const metadata: Metadata = {
  title: "Best Brokers 2025 - Top Trading Platforms Categorized | BrokerAnalysis",
  description: "Find the best brokers for forex, stocks, crypto, beginners and more. Detailed categories to help you find the perfect trading platform for your needs.",
};
...
async function getCategoriesWithBrokers() {
  try {
    ...
    const typeCategories: CategoryCard[] = [
      ...
      {
        title: "Best Mobile Trading Platforms",
      ...
      {
        title: "Best Commodities Brokers",
      ...
      {
        title: "Best Penny Stock Brokers",
      ...
      {
        title: "Best International Brokers",
    ...
    const regionCategories: CategoryCard[] = [
      ...
      {
        title: "Best Brokers in Australia",
      ...
      {
        title: "Best Brokers in Singapore",
    ...
    const experienceCategories: CategoryCard[] = [
      // Create these in the same way as above, with await getTopBrokersForCategory() calls
      {
        title: "Best Brokers for Beginners",
        description: "User-friendly platforms with excellent educational resources and low minimum deposits.",
        icon: <BookOpen className="h-8 w-8 text-primary" />,
      ...
      {
        title: "Best Brokers for Intermediate Traders",
      ...
      {
        title: "Best Brokers for Day Traders",
      ...
      {
        title: "Best Brokers for Swing Traders",
      ...
      {
        title: "Best Brokers for Professionals",
      ...
      {
        title: "Best Brokers for Retirement Accounts",
    ...
    const featureCategories: CategoryCard[] = [
      ...
      {
        title: "Best Brokers for Research",
      ...
      {
        title: "Best Brokers for Education",
      ...
      {
        title: "Best Low Deposit Brokers",
      ...
      {
        title: "Best Brokers for Customer Service",
    ...
    <div className="container py-12 max-w-7xl mx-auto">
      <div className="max-w-3xl mx-auto text-center mb-16">
        ...
        <p className="text-xl text-muted-foreground">
          Find the perfect broker for your trading needs with our expert-curated lists across various categories.
        </p>
      </div>
      ...
      <section className="mb-20">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-3xl font-bold">By Market Type</h2>
      ...
      <section className="mb-20">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-3xl font-bold">By Region</h2>
          <div className="flex items-center gap-2">
      ...
      <section className="mb-20">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-3xl font-bold">By Experience Level</h2>
          <div className="flex items-center gap-2">
      ...
      <section className="mb-8">
        <div className="flex items-center justify-between mb-8">
          <h2 className="text-3xl font-bold">By Features</h2>
          <div className="flex items-center gap-2">
