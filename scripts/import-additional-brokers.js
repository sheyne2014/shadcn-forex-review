...
function getAdditionalBrokers() {
  return [
    ...
    { name: 'Crypto.com', rating: 4.5, logo_url: 'https://example.com/crypto.png', min_deposit: 0, trading_fee: 0.4, country: 'Hong Kong', regulations: 'MFSA, FCA', supported_assets: ['Bitcoin', 'Ethereum', 'Altcoins'], categories: ['Cryptocurrency Brokers'] },
    ...
    { name: 'Gate.io', rating: 4.3, logo_url: 'https://example.com/gateio.png', min_deposit: 0, trading_fee: 0.2, country: 'Cayman Islands', regulations: 'Various', supported_assets: ['Bitcoin', 'Ethereum', 'Altcoins'], categories: ['Cryptocurrency Brokers'] },
