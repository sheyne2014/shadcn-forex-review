# Run broker reviews import script V2 (improved version)
...
Write-Host "Starting import of broker reviews (improved version)..." -ForegroundColor Green
...
node scripts/import-broker-reviews-v2.js $supabaseUrl $supabaseKey
